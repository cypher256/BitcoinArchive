---
title: "サトシからマイク・ハーンへ：マイクロペイメント（2009-04-13）"
...
<!-- speaker: Satoshi Nakamoto -->
キースペースは巨大で、2^256 だ。ハッシュされるものにはノードの公開鍵とランダムなナンスが含まれるため、2 つのノードが同じ空間で作業を重複させる可能性は無視できる。
