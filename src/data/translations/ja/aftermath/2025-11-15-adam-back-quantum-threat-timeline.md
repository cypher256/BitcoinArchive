...
本アダム・バック量子脅威発言は[ビットコイン量子脅威分析](/BitcoinArchive/ja/entries/analysis/2026-05-18-bitcoin-quantum-threat/)によって、 §4 の年表論証における二つの錨データ点の一つ (もう一つは NSA 2035 年制度的線) として扱われ、 §6 では「名指しの暗号学者隣接の年表における最も記録の確かな二点の一つ」 として再引用される。
