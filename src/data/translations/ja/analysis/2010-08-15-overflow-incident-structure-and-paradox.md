...
本構造的パラドックス分析は[バリュー・オーバーフロー事件エントリ](/BitcoinArchive/ja/entries/aftermath/2010-08-15-value-overflow-incident/)から、 2010 年 8 月事件についての規範的な読解として扱われる。同エントリは本分析を、同じ 5 時間復旧の「分散対中央集権の緊張」読解として参照する。
