...
participants:
  - name: "Pieter Wuille"
    slug: "pieter-wuille"
description: "Introduced hierarchical deterministic (HD) wallets — an entire tree of key pairs derived from a single master seed. Eliminated frequent-backup needs and enabled organized parent-child key derivation."
isSatoshi: false
tags:
  - "bip"
  - "hd-wallet"
...
![BIP 32 hierarchical key derivation diagram showing master extended key branching into child keys via CKD functions](/BitcoinArchive/images/bips/bip-0032-derivation.png)
