...
description: "Satoshi Nakamoto's reply in the thread \"Hostnames instead of IP Addresses\"."
isSatoshi: true
secondarySources:
...
The user would send to domain.com (or [www.domain.com](http://www.domain.com) is ok too).  That would be very natural and users could see and verify that what they entered is who they intend to pay.
