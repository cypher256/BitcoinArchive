...
「人為的に強制された希少性」が指すのは、[2,100 万枚の上限](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)そのものだ。パーマーは、ドージコインの上限のなさを弁護する形でこの一文を書いたのではない。それでも並べれば構図は一つになる ─ 供給に天井を持たない通貨を作った当人が、供給に天井を持つ通貨のほうを、価値の保存ではなく富の集中の道具だと名指しした。
