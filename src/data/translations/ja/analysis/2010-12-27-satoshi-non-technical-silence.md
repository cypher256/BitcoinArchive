...
「メリークリスマス、サトシ。君が世界のどこにいるのかも…」と書かれたメールに、返ってきたのは SPV の設計論だった。「ありがとう」も「君もね」もない。サトシの通信記録には、この小さなすれ違いが繰り返し現れる。プロトコルのためには開く通信路が、ひとりの人物が見えそうになると閉じる。
...
ここに残るのは、冷たい人物像でも、秘密主義の人物像でもない。挨拶、称賛、場所、感情が通信の端まで届くと、返信はプロトコルへ戻るか、そこで止まる。その境界にはマルミとのまれな例外もある。共有する思想の場では姿を見せながら、個人の記録からは姿を消すという二重性が、この沈黙を単なる無愛想では終わらせない。
