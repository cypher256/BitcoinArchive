...
The transaction layer this entry describes is the routing centre of the design-document cluster: the [block-chain design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-block-chain-design/) reads transactions as block contents, the [cryptography design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-cryptography-design/) reads transactions as the consumer of signatures and hashes, the [monetary design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-monetary-design/) reads transactions as the coinbase and fee mechanism, the [P2P network design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-p2p-network-design/) reads transactions as the inv/tx propagation payload, the [storage design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-storage-design/) reads transactions as the UTXO-set update unit, the [wallet design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-wallet-design/) reads transactions as the constructed and signed object, and the [ecosystem design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-ecosystem-design/) reads transactions as the unit the broader fee market and Lightning-Network ecosystem operate on.
