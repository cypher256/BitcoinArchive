...
2008年8月、サトシはBackにHashcash論文の引用を確認するために連絡した。Backは引用を確認し、ウェイ・ダイのb-money提案を参照するよう提案した。

「b-moneyを調べるよう提案した。その時点では知らなかったようだ」

サトシは返信した：「ありがとうございます。b-moneyのページは知りませんでしたが、私のアイデアはまさにその地点から始まっています」

**最大の後悔について：**

「ビットコインホワイトペーパーを最初に注意深く読まなかった。それがおそらく最大のミスだ」

Backは添付されたホワイトペーパーを開き、ざっと目を通し、ウェイ・ダイのb-moneyを提案する簡潔な返信を打って、ラップトップを閉じた。ビットコインを積極的に使い始めたのは2013年頃からだった。
...
COPA対クレイグ・ライト裁判で、Backはロンドン高等法院で直接証言し、サトシとの完全な5通のメールチェーンを証拠として提出した。2008年8月20日以降のメールが初めて公開された。

*[Backは2014年にBlockstreamを設立し、最も著名なビットコインインフラ企業の一つとなった。早期に関与しなかったことへの後悔にもかかわらず、彼のHashcashの発明はビットコインのプルーフ・オブ・ワーク合意メカニズムの基本的な構成要素であり続けている。]*
