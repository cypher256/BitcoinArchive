...
ドナルドの懐疑論はサトシの最も詳細な初期アーキテクチャ説明を公的記録に引き出した —— 簡易決済検証、信頼と二重支払いのモデル。ドナルドは長年サイファーパンクコミュニティで活動する暗号学者・リバタリアン評論家。jim.com というウェブサイトを運営し、暗号学・政治哲学・経済学について執筆していた。
