...
participants:
  - name: "BitcoinFX"
    slug: "bitcoinfx"
description: "Context post by BitcoinFX in BitcoinTalk topic 34. after msg222, quotes Satoshi."
isSatoshi: false
tags: []
quotes:
  - id: "q1"
...
Please email: bitcoinfx @ gmail.com regarding any issues. (EDIT: no longer in use 2014)

You can also visit my website: BitcoinFX - http:// www .bitcoinfx .cz.cc EDIT: Domain no longer active - An early manual e-currency exchange by email only - the domain only provided contact info. etc.
