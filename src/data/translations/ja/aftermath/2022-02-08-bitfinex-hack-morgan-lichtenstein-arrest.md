...
本 2016 年 Bitfinex ハックとその 2022 年法執行による回収は[失われたビットコイン横断ページ](/BitcoinArchive/ja/entries/analysis/2026-06-02-bitcoin-iconic-losses-overview/)から、そうでなければ損失中心の目録に対する代表的な「不可逆性原則に対する回収」の対照事例として扱われる。
