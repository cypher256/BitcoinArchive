...
- **COPA v Wright (英国高等裁判所、2024 年 3 月 14 日)** — ジェームズ・メラー判事がクレイグ・ライトに対し 4 つの認定を下した: ビットコイン論文の著者ではない、2008〜2011 年にサトシとして活動した人物ではない、ビットコインシステムの作成者ではない、初期 Bitcoin ソフトウェアの著者ではない。判決はライトが「サトシ・ナカモトであるという虚偽の主張を支えるために、意図的かつ広範な文書偽造を行った」 と結論付けた。詳細は [COPA 判決エントリ](/BitcoinArchive/ja/entries/aftermath/2024-03-14-copa-v-wright-ruling/) 参照。
