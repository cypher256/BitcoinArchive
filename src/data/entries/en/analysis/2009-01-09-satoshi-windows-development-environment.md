...
Satoshi himself stated in his [November 2008 reply on the cryptography mailing list](/BitcoinArchive/entries/emails/cryptography/bitcoin-p2p-e-cash-paper/2008-11-17-bitcoin-p2p-e-cash-paper/) that he had "worked through all those little details over the last year and a half while coding it," and later told [Martti Malmi in July 2009](/BitcoinArchive/entries/correspondence/martti-malmi/2009-07-21-bitcoin-024/) he needed "a break from it after 18 months development." A self-attested ~18-month coding span ending around the v0.1 release places the start of coding in mid-2007 at the latest. Satoshi himself documented the work order: "I had to write all the code before I could convince myself that I could solve every problem, then I wrote the paper" ([to Hal Finney, November 10, 2008](/BitcoinArchive/entries/emails/cryptography/bitcoin-p2p-e-cash-paper/2008-11-10-re-bitcoin-p2p-e-cash-paper-satoshi-finney/)). The paper came after the code was substantially complete, not before it. The later "Since 2007" / "2 years of development before release" framings ([Hanyecz, 2010-06-18](/BitcoinArchive/entries/forum/bitcointalk/topic-195/2010-06-18-re-transactions-and-scripts-dup-hash160-equalverify-checksig/); [Hearn, 2011-01-10](/BitcoinArchive/entries/correspondence/mike-hearn/more-questions/2011-01-10-satoshi-to-hearn-secp256k1/)) describe the same pre-release work at wider scopes, not a separate pre-coding design phase: the approximately-2-year retrospective adds the months Satoshi was thinking through the problem before opening an editor. The Phase 1 boundaries here track the *coding* span and the public release. The full self-statement timeline is collected in [the cypherpunk-independent-arrival analysis](/BitcoinArchive/entries/analysis/2008-10-31-cypherpunk-independent-arrival/).

The v0.1 release ships on January 9, 2009 as a Windows-only `.rar` archive on SourceForge. For another seven months after that — until the very end of August 2009 — Bitcoin's source code lives only on Satoshi's local machine, distributed as successive `.rar` releases. Across this entire twenty-seven-month window, the archive contains:
...
Jeff Garzik, an early core developer who worked with Satoshi from 2010, later made the same observation from outside the code: Satoshi combined well-known cryptographic building blocks in a novel way but lacked formal computer-science training in modularity and unit testing (see [the Garzik retrospective](/BitcoinArchive/entries/aftermath/2024-10-28-jeff-garzik-satoshi-lone-genius/)).
...
[The Wei Dai identity hypothesis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/), [the Hal Finney identity hypothesis](/BitcoinArchive/entries/analysis/2014-03-25-hal-finney-satoshi-identity-hypothesis/), and [the Peter Todd identity hypothesis](/BitcoinArchive/entries/analysis/2024-10-08-todd-satoshi-identity-hypothesis/) each weigh the candidate's documented working environment against the Windows-only pattern recorded here, and [the identity-hypotheses overview](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/) applies that same test as a constraint on candidate selection across the whole field. [The architecture-evolution design entry](/BitcoinArchive/entries/design/2009-01-03-bitcoin-architecture-evolution/) reads the Windows-centric early codebase as the starting point of architectural drift — the technical decisions inherited from Phase 1 that successor maintainers had to live with.
...
<!-- entry-closing -->
The environment never changed; only the people around it did. Every door out of Windows in this record was opened by someone else, and the last artifact the record holds is a signature footer the machine wrote on its own. Satoshi ended where he began. I can say so only because he never once said it himself.
