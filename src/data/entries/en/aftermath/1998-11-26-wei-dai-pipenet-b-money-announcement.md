...
tags:
  ...
  - "origins"
  - "historic"
editorNote: "This post is historically significant because it reveals that b-money — later cited as reference [1] in the Bitcoin whitepaper — was not Wei Dai's primary project. It was announced as a side note to PipeNet 1.1. Adam Back later forwarded the full b-money text to the mailing list on December 5, 1998, which sparked broader discussion."
secondarySources:
  - name: "Adam Back's forwarding of b-money protocol (Dec 5, 1998)"
    url: "http://cypherpunks.venona.com/archive/1998/12/msg00194.html"
  - name: "Wei Dai — b-money proposal"
...
This entry is the primary-source anchor for several later analyses and articles that read b-money's place in Bitcoin's design lineage and in identity-hypothesis arguments: the [bit-gold-and-precursor design lineage](/BitcoinArchive/entries/analysis/2008-10-31-bitcoin-design-lineage/), the [Hayek-Extropians-Bitcoin ideological lineage](/BitcoinArchive/entries/analysis/1976-10-25-hayek-extropians-bitcoin-lineage/), the [Wei Dai identity hypothesis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/), the [fixed-supply-vs-adjustable-money analysis](/BitcoinArchive/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/), and the [mining-reward-exhaustion analysis](/BitcoinArchive/entries/analysis/2026-05-18-mining-reward-exhaustion-fee-only-future/). The [Adam Back b-money monetary critique](/BitcoinArchive/entries/aftermath/1998-12-06-adam-back-b-money-monetary-critique/) and the [Hashcash announcement](/BitcoinArchive/entries/aftermath/1997-03-28-adam-back-hashcash-announcement/) sit alongside this announcement as the same-period precursor record, and the [Wei Dai biography](/BitcoinArchive/participants/wei-dai/) and [Wei Dai retrospective on Satoshi](/BitcoinArchive/entries/aftermath/2014-01-12-wei-dai-retrospective-on-satoshi/) provide the longer participant arc.
