...
description: "Pay-to-Merkle-Root (P2MR), a quantum-resistant output type. Like Taproot without the quantum-vulnerable key path spend — commits only to the Merkle root of a script tree. SegWit v2, soft fork."
isSatoshi: false
tags:
  - "bip"
  - "quantum-resistance"
...
![Construction of P2MR script tree root, scriptPubkey, and Witness](/BitcoinArchive/images/bips/bip-0360-merkletree.png)
