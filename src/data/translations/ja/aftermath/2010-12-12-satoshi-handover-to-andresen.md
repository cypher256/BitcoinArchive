...
<!-- speaker: narrator -->
継承は、式典の一瞬には起きなかった。12 月 3 日から 19 日までの間に、メールでの推薦、リポジトリへのアクセス、そして気の進まない公開表明が重なり、ギャビン・アンドレセンは実務上の後継者になった。コードの管理権とプロジェクトを公に担う責任は結び付いていたが、記録に残る移行は一つの瞬間ではなく、連続した出来事である。
...
<!-- speaker: narrator -->
この承認は、2010 年を通じたアンドレセンの貢献の積み重ねを経たものだった。コミット権限は 12 月 12 日に正式化され、アンドレセンがプロジェクト管理を公に引き受けたのは 12 月 19 日である。二つの出来事は、リポジトリと公的な看板を一つの引き継ぎとして結んだが、同時に起きたわけではない。アンドレセンはその後、後に Bitcoin Core と改称される参照実装を、2014 年に次の管理者へ引き渡すまで維持した。
