...
description: "BitcoinTalk トピック 823 における NewLibertyStandard の文脈投稿。after msg9648, サトシを引用."
isSatoshi: false
tags: []
quotes:
  - id: "q1"
...
> >
> > 74638 以降、すでに 14 ブロック生成している。0.3.10 のビルドは 2〜3時間前にアップロードされた。私が接続しているノードのうち、半数以上がすでに 0.3.10 だ。おそらく不正チェーンよりも多くの計算力をすでに持っていると思う。
>
