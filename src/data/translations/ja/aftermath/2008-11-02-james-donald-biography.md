...
2008年11月2日 — サトシ・ナカモトが10月31日に暗号学メーリングリストにビットコインホワイトペーパーを投稿してから2日後 — ドナルドは最初に公に返信した人物となった。彼の返信はスケーラビリティに関する即座の懸念を提起し、「我々はこのようなシステムを非常に必要としているが、あなたの提案を理解する限り、必要な規模にスケールするようには見えない」と書いた。すべてのノードがすべてのトランザクションを処理する必要があり、広範な利用には非現実的だと主張した。
