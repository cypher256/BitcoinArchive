...
- ビットコイン・インスティテュートの役割は、サトシが何を書いたか、コードがネットワークに何を強制しているか、そして専門的な分析がこれまでに何を問題として提起してきたかを記録することにある。
