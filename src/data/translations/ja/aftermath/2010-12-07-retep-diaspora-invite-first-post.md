...
トッド本人は 2024 年の Bloomberg インタビューで、2010 年 12 月の投稿時点で「retep」というハンドルは実名と公には結びついていなかったと述べた。また、もしサトシに紐づくアカウントから誤投稿したのであれば普通はアカウント自体を破棄するはずで、数年後に実名へ改称する動きとは整合しないとも論じ、HBO 説への反論材料とした。(Bloomberg の元記事は有料の壁の向こうにあり公開ミラーが取れないため、ここでは逐語的な引用ではなく公開要約に基づく地の文で記述している。)
