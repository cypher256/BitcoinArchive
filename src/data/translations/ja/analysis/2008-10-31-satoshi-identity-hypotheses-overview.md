...
各候補を、能力スコア（x 軸、能力 5 次元の平均）と隠匿性スコア（y 軸、隠匿性 2 次元の平均）の 2 次元空間にプロット。🟢 = 1、🟡 = 0.5、🔴 = 0 で換算。マップは §7 の横断的観察を空間的に可視化する：サトシが引用したサイファーパンク候補（アダム・バック、ウェイ・ダイ、ハル・フィニー、サボ）は能力高・隠匿性低の帯に集中、サッサマンが能力高・隠匿性高の象限に唯一位置、ライト・ドリアン・金子勇は能力低の領域。
