...
By early 1996, [Wei Dai](/BitcoinArchive/participants/wei-dai/) had already created and publicly released multiple software projects, including the Crypto++ cryptographic library.

Crypto++ was [later integrated into Bitcoin itself by Satoshi in v0.3.6 (July 2010)](/BitcoinArchive/entries/forum/bitcointalk/topic-572/2010-07-27-blackeye-msg6093/), with a subset (SHA-256 plus general dependencies) added to the SVN to speed up hash computation — meaning Dai's code became a direct dependency of Bitcoin itself. Crypto++ was also used in commercial products such as Microsoft Office Groove and LastPass. That same codebase dependency is examined in [the Wei Dai Satoshi-identity hypothesis analysis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/), which credits the SSE2 optimization to a forum proposal by BitcoinTalk member BlackEye rather than to Satoshi alone.
