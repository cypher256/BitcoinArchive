---
title: "イーロン・マスク（1971–） — テスラ・SpaceX 創業者、2017 年のブログでサトシ候補に挙げられた"
...
participants:
  - name: "Elon Musk"
    slug: "elon-musk"
description: "イーロン・マスク（1971–）：テスラ・SpaceX 創業者。2017 年のブログがサトシと名指したが一週間以内に否定。ビットコインとの関わりはテスラの 2021 年購入とドージコイン。"
isSatoshi: false
callout:
...
```mermaid
timeline
    1971 : 南アフリカ・ プレトリア生まれ (6月)
    1999 : X.com を共同創業 （後の PayPal）
    2017 : Sahil Gupta の ブログがマスクを サトシ候補と名指し (11月22日)
    %% link: /BitcoinArchive/ja/entries/analysis/2017-11-22-elon-musk-satoshi-identity-hypothesis/
         : マスクが Twitter で否定 「事実ではない… どこにあるか分からない」 (11月28日)
    2020 : マスクのアカウントが ビットコイン詐欺の Twitter 乗っ取りで 被害 (7月)
    %% link: /BitcoinArchive/ja/entries/aftermath/2020-07-15-twitter-hack-bitcoin-scam/
    2021 : テスラが 15 億ドルの ビットコイン購入を開示、 ドージコイン を後押し
```
