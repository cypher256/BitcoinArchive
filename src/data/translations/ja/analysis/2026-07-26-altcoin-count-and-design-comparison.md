...
その立場は六つに分かれ、それぞれに、読み手が実際に見る二つの数への帰結が定まっている。[固定供給と自動調整の比較](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)は、各企画がその立場を採ったときにどの失敗を避けようとしたのかを、1998 年の b-money からイーサリアムのマージまでたどっている。
