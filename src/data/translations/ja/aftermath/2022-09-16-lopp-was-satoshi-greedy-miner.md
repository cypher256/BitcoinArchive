...
「奪おうと思えば奪えたのに自制した採掘者」というこの人物像は、これより 5 年近く前、[レイ・ディリンジャー](/BitcoinArchive/ja/entries/aftermath/2017-09-20-ray-dillinger-if-id-known/) ― ビットコインのブロックチェーンコードを最初期にレビューした人物の一人 ― によって、すでに定性的な形で描かれていた。ロップの分析は、その印象に数値的な裏付けを与えている。
