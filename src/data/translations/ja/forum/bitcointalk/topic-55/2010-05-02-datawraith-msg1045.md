...
アドレスという意味がよく分からないが、Bitcoin の署名で提供される「アドレス」以外を指しているのか。すでにエイリアスが定義されていない限り、異なる人に異なるアドレスを渡す方法が分からない。つまり、Bitcoin ノードのエイリアスをエンコードして変換する命名システムを追加することを提案しているのか？それはそれほど手間なくできるだろう。
