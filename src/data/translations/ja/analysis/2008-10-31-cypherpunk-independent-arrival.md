...
サトシ本人の枠付けでは、 設計期間はコーディング期間より長く、 より早く始まっている。 「約 18 か月」 はコーディングを測る数値であり、 「2007 年から」 と「リリース前に 2 年間の開発」 はその内側にコーディングを含むより広い期間を示している。
...
これが、 プロジェクトの公開前段階 (2007 年半ばから 2008 年 8 月までのコーディング期間。 その内側は、 サトシが後に「2007 年から」 と述べたより広い設計期間に置かれる) に b-money — 設計空間上で最も近い先行提案 — を知らなかったことを、 [サトシ自身の言葉](/BitcoinArchive/ja/entries/analysis/2008-08-20-satoshi-self-statements/)で確認する一次資料である。 サトシはこれを知った後、 翌日 (2008 年 8 月 22 日) にウェイ・ダイへ直接連絡し、 ホワイトペーパーに [1] として引用を追加した。
...
- ビットコイン設計期間中 (約 18 か月のコーディング期間が 2007 年半ばから 2009 年 1 月の v0.1 リリースまで、 サトシの同時期の自己発言による。 その内側に「2007 年から」「リリース前に 2 年間の開発」 という、 サトシが後に述べたより広い設計期間が含まれる。 実装作業は 2008 年 8 月までに実質的に完了)、 サトシは Hashcash を知っており、 b-money を知らなかった — 2008 年 8 月 21 日のアダム・バック宛の言葉で確定
