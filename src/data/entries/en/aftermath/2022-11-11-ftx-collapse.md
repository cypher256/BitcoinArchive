...
This FTX collapse is treated as a load-bearing custody-axis example by [the Satoshi-design-vs-current-reality analysis](/BitcoinArchive/entries/analysis/2026-05-24-satoshi-design-vs-current-reality/), which uses FTX alongside the Mt. Gox bankruptcy to exemplify the bank-failure mode the protocol was designed to prevent — affected users had no protocol-level claim on any coin, only a contractual claim against an insolvent company.
