...
This incident is the central reference for several adjacent records: [the structural paradox analysis](/BitcoinArchive/entries/analysis/2010-08-15-overflow-incident-structure-and-paradox/) reads the same five-hour recovery as the canonical case of decentralized-vs-centralized tension; [the knightmb snapshot-and-legend analysis](/BitcoinArchive/entries/analysis/2010-08-15-knightmb-snapshot-and-legend/) covers the contributor whose pre-incident blockchain snapshot the recovery patch depended on; [the Slashdot Bitcoin article (July 2010)](/BitcoinArchive/entries/aftermath/2010-07-11-slashdot-bitcoin-article/) and [the knightmb biography](/BitcoinArchive/participants/knightmb/) provide the immediate pre-incident context; and [the Mt. Gox bankruptcy entry](/BitcoinArchive/entries/aftermath/2014-02-28-mt-gox-bankruptcy/) treats this incident as the early counter-example of "the protocol survived" used in custodial-collapse discussions.

*[Context: The five-hour patch deployment of August 15, 2010 is one of the named scenes in the novel [*Genesis: The Disappearance of the Founder and the Promise*](/BitcoinArchive/novel/) — the protagonist confronts a 184-billion-BTC chain corruption and ships a soft-fork release before the network can split.]*
