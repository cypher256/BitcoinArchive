...
**ビットコインとの関わり：**
2009年1月25日 — Bitcoin v0.1のリリースからわずか2週間後 — ボームはSourceForgeのbitcoin-listメーリングリストにソフトウェアの動作問題を投稿した。問題を報告する場としてこのリストが適切かどうかを尋ねた。サトシ・ナカモトは同日中に返信し、詳細を求めるとともに、診断のためにdebug.logファイルを直接送るよう依頼した。
