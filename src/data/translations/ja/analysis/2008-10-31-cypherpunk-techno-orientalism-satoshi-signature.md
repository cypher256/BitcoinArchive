...
別だが関連する論点として、署名「サトシ・ナカモト」（メーリングリスト等にはローマ字綴りの形で現れる）そのものを、1980〜90 年代のサイバーパンクおよびテクノオリエンタリズム的な記号空間に対して読む。後者は記述的な読みであって、サトシの意図についての主張ではない。
...
## 5. 「サトシ・ナカモト」という署名：テクノオリエンタリズム的な読み
...
1. **受容は事前に形成されていた**。Bitcoin コミュニティが「サトシ・ナカモト」（公開記録上はローマ字綴り）を「ネットワーク深部の匿名知性」として連想する傾向は、特異なものではない。署名に対して作品群が作動した結果である
...
- 意図とは独立に、「サトシ・ナカモト」という署名は 1980〜90 年代のテクノオリエンタリズム的な象徴空間の内側に落ちる。これは受容についての構造的観察であって、日本人著者性または特定の身元の証拠ではない
