...
sourceNote: "本エントリーは既存文書の転載ではなく、ビットコイン・インスティテュート自身が行った一次的な実験である。2026年8月2日、5 つの AI 製品に同一の質問を投げかけ、その回答を記録した（1 件のみ例外があり、§6 に記す）。5 製品のうちどれか 1 つが他より優先される出典ではないため、sourceUrl は設定していない。5 製品すべてのページと、各 AI の主張を検証した際の出典は secondarySources に列挙している。"
