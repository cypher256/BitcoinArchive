...
その後のやり取りでは、IP アドレスによるビットコイン送金の安全性の問題についても触れられた。サトシはこれらの議論も一因として、最終的に IP 送金機能をソフトウェアから完全に削除した。同じ「手作業で頼まれて送る」という配布パターンは 1 か月後、[ミシェル・バウエンスがビットコインは稼働しているかと尋ね、同じ申し出を受けた](/BitcoinArchive/ja/participants/michel-bauwens/)ときにも繰り返された。
