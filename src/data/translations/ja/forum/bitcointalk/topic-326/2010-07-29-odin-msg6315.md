...
<!-- quote: q1 -->
> こちらでは glibcxx_3.4.11 とリンクするように指定すらしていない。だから gcc が裏で自動的にリンクしているはずだ。おそらくそれを静的リンクするようにと指示するコンパイラースイッチがあるだろう。ライセンス上の問題がどうなるかはわからない。一般的にコンパイラー関連のものは完全に再配布可能だ。
