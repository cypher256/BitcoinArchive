...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "一見したところ、bitcoinshop.comのほうがよさそうです。bitcoinexchange.comはbitcoinx.comより良いかもしれません。"
isSatoshi: true
...
一見したところ、bitcoinshop.comのほうがよさそうです。bitcoinexchange.comはbitcoinx.comより良いかもしれません。

ドメイン名を検索する場所には注意してください。多くの業者がフロントランニング（先回り登録）をします。Network Solutionsでさえそうです。ただし、ホームページではなくwhoisページを使えば問題ないと言っています。安全な場所はここだけです：
