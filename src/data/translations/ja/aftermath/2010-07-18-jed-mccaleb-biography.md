...
後半の一文が構造上の断絶にあたる。ビットコインの供給は時間をかけて、仕事をした者へ発行される。XRP の供給は最初のブロックの時点で全量が存在し、創設者たちの手にあった。[固定供給と自動調整の比較](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)が扱うのは発行計画の論点である。初日に誰がコインを持っているかという配分の論点はそれとは別の軸で、事前生成型のチェーンが採掘型ともっとも鋭く分かれるのがこの軸になる。
