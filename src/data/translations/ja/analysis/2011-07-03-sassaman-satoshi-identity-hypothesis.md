...
| 反証 | 中心観察 | 強度の評価 |
|---|---|---|
| §3.1 直接的な文書上の繋がりの不在 | サスマン↔サトシ間の通信、共同コミット、ビットコイン関与の痕跡が公開コーパスに皆無 | 仮説の最も強い反証 — 仮説の維持にはすべてが公開記録の外で起きた必要がある |
| §3.2 パターソンの沈黙 | サスマンの妻メレディス・パターソン（暗号学者）は仮説を肯定も否定もしていない | 情報ではあるが、沈黙自体は事後確率をどちらにも動かさない |
| §3.3 KU Leuven の負担 | サスマンは 2008–2011 年に KU Leuven COSIC の PhD 候補生で、ビットコインの約 18 ヶ月の集中開発期間と重複 | 可能だが負担増大 — 完全否定ではない |
