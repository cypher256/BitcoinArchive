...
- **結論しない**。[身元仮説総覧 §7「全体の限界」](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/) と[匿名性のアーキテクチャ §9「本エントリの限界」](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-anonymity-architecture/) と同じスタンスで、本エントリは観察と提示された代替案を並べるに留め、いずれかにコミットしない。
