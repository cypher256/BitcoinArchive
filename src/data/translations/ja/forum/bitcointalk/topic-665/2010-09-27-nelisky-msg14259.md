...
participants:
  - name: "nelisky"
    slug: "nelisky"
description: "BitcoinTalk トピック 665 における nelisky の文脈投稿。msg18349 の前。"
isSatoshi: false
tags: []
...
quotes:
  - id: "q1"
    ...
    sourceEntryId: "forum/bitcointalk/topic-665/2010-09-27-gavin-andresen-msg14254"
---
...
- ユーザーがジャックポットに当選するが、賞金は実際には複数のユーザーのアカウントに保持されているので
  ...
  b) コインをそのままにして、配当時に通常の sendtoaddress を行う（外部取引であり、ラベル会計ロジックを壊す）
