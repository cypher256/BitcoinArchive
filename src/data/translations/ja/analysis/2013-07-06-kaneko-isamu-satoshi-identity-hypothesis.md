...
仮説の主張は以下の通り：金子はサトシ・ナカモトの仮名でビットコインを設計・実装した（時期は 2007 年から 2010 年頃）。最高裁への検察側上告期間（2010–2011 年）の頃にプロジェクトの活動的な関与から退き、2013 年 7 月の死をもって、サトシ時代のビットコインへの関与は事実上の終焉を迎えた。
