...
This rebrand-authority analysis is invoked by two later readings as the naming-axis component of the 2014–2017 governance arc. [The fork-wars-as-not-OSS analysis](/BitcoinArchive/entries/analysis/2015-08-15-bitcoin-fork-wars-as-not-oss/) cross-references this entry as the naming axis of its structural reading of Bitcoin's governance. [The Mike Hearn "Resolution" essay](/BitcoinArchive/entries/aftermath/2016-01-14-mike-hearn-resolution-bitcoin-experiment/) treats this rebrand as one of the inflection points its governance-failure verdict turns on.
