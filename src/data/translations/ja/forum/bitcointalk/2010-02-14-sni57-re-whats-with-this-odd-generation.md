...
その通りだ。そうでなければ、2100万コインという有限の上限を設けることはできなかっただろう。生成に対する最低限の報酬が常に必要になるからだ。数十年後に報酬が小さくなりすぎると、トランザクション手数料がノードの主な報酬になる。20年後にはトランザクション量が非常に大きいか、まったくないかのどちらかだろう。
