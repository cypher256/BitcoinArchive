---
title: "サトシが P2P Research メーリングリストにビットコインを紹介 — 「[p2p-research] Bitcoin open source implementation of P2P currency」（2009-02）"
...
description: "サトシ・ナカモトが P2P Research メーリングリストでビットコインを紹介。信頼に基づく従来の通貨の問題点と、暗号学的証明とピアツーピアネットワークによる二重支払い解決を説明。"
isSatoshi: true
tags:
  - "announcement"
  - "trust"
