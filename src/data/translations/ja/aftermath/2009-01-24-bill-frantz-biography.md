...
**メーリングリストでの貢献：**
2009年1月24日、フランツはプルーフ・オブ・ワーク・トークンがセキュリティにインセンティブを生むという[ハル・フィニー](/BitcoinArchive/ja/entries/aftermath/2014-08-28-hal-finney-biography/)の議論に応答した。ボットネットとネットワークセキュリティの関係について、特徴的な皮肉を込めた観察を行った。
