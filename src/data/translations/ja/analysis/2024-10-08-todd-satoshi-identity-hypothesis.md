...
2. **2 番目の投稿（2010 年 12 月 10 日）：** サトシへの返信 — 「もちろん、正確に言えば、二つ目のトランザクションに手数料がある場合、入力と出力は*正確には*一致しない」 — は冷静で技術的に正確、抑制的。冒頭の「Of course」にはさりげない確信が漂うが、全体の語調は中立的。罵倒、自虐、攻撃的な皮肉 — 後にトッドの文体を特徴づけるもの — はまだ見られない。
