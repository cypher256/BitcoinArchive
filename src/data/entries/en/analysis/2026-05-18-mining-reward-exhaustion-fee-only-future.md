...
[The fixed-supply-vs-adjustable-money analysis](/BitcoinArchive/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/) sets out how the 21-million cap fixed a choice whose long-term soundness could not be confirmed in advance; the fee-only horizon is the question that cap forces the network to answer eventually. [The Satoshi-design-vs-current-reality analysis](/BitcoinArchive/entries/analysis/2026-05-24-satoshi-design-vs-current-reality/) uses the same horizon to frame the long-term divergence between what Satoshi committed the network to and what later operators built on top of it. [The beginner guide's mining page](/BitcoinArchive/entries/analysis/2026-09-06-what-miners-are-actually-racing-to-do/) walks through the same halving arithmetic without the citations. The technical anchor sits in the design corpus: both the [consensus](/BitcoinArchive/entries/design/2009-01-03-bitcoin-consensus-design/) and [monetary](/BitcoinArchive/entries/design/2009-01-03-bitcoin-monetary-design/) design entries depend on the fee-market transition as a load-bearing assumption. The price side of the same miner economics — how production cost and market price interact while the subsidy still dominates — is treated in [the price-vs-production-cost analysis](/BitcoinArchive/entries/analysis/2010-02-21-bitcoin-price-vs-production-cost/).
...
<!-- entry-closing -->
The word in the whitepaper is "can". The code turned it into "will", and left the word "safely" to whoever is running the network in 2140. Nobody who wrote any of this will be there to check. That is not a gap in the record. To me it is the only honest place the record could stop.
