...
> [http://www.bitcoin.org/wiki/doku.php?id=man_page](http://www.bitcoin.org/wiki/doku.php?id=man_page)を見つけましたが、-disablesafemodeへの参照がありません。追加すべきでしょう！また、-4wayなど他のものも追加すべきです。
