...
The three addresses are treated as established public record — attested by the metzdowd cryptography-list archive of the whitepaper announcement itself, published correspondence on `mmalmi.github.io/satoshi` and `plan99.net`, and Bitcoin Magazine's released Adam Back correspondence.
...
|---|---|---|
| September 2010 | Satoshi tells Gavin Andresen privately that he is "working on other projects." Exact date and medium not in the public record; reconstructed from Andresen's later recollection. | Gavin Andresen interview (CoinMarketCap "Satoshi Files: Gavin Andresen") |
...
| December 5, 2010 | WikiLeaks-related thread "Bring it on" on BitcoinTalk; Satoshi posts public objection: "No, don't 'bring it on'. The project needs to grow gradually so the software can be strengthened along the way." | [BitcoinTalk thread](/BitcoinArchive/entries/forum/bitcointalk/topic-1735/2010-12-05-re-wikileaks/), examined in full in [the WikiLeaks-and-Bitcoin entry](/BitcoinArchive/entries/aftermath/2011-06-14-wikileaks-accepts-bitcoin/) |
...
- **The disposition of the approximately 1.1 million BTC associated with the Patoshi mining pattern** (Lerner 2013, full figure across 22,503 blocks discussed in [the identification-asymmetry analysis](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identification-asymmetry/)). What is observable: those coins have not moved on-chain since the early-2010 mining period. What is *not* observable: whether the corresponding private keys have been retained, lost, deliberately destroyed, or held by a successor.
...
- The six-layer organization is a reading. Other readings are possible — for example, organizing the same traces by attack surface (forensic class) rather than by participation phase (chronological class).
