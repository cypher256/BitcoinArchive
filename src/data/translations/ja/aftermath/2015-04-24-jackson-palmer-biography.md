...
ビットコイン・インスティテュートはこの発言を記録し、その当否を裁定しない。ただし一節だけは政治の話ではなく、特定の設計判断についての主張である。「人為的に強制された希少性」とは 2,100 万枚の上限のことであり、パーマーは、固定供給が価値の毀損に対する防御ではなく富の集中の仕組みとして働いていると主張している。[固定供給と自動調整の比較](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)は、同じ設定値についての二つの読みを両方並べており、そこでも決着をつけていない。
