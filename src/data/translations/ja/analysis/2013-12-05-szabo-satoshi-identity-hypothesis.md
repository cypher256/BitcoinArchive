...
### 2.2 2011 年 5 月のブログ投稿『ビットコイン、なぜこんなに遅く来たんだ』
...
自己否定はそれ自体では決定的でない。ライトは自称し明らかに虚偽だった。ドリアン・ナカモトは自己否定し明らかに正しかった。否定の価値は、それを取り巻くものに依る。自設計の欠陥を直した別人としてナカモトを遇する 2011 年 5 月投稿の枠組み、Unenumerated の継続活動、2008 年 4 月の実装支援募集コメント、矛盾する行動の不在。サボの否定は、これらすべてに取り巻かれており、すべてサボがサトシでないことと内的に整合する。
...
- 新たな証拠（直接の文書接続、ビットコイン v0.1 にサボの他の公開コードと一致する技術的指紋、サボがそれまでの公的立場と矛盾する発言など）が出現した場合は、記録と評価を更新する。
