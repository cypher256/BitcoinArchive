...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "I think the biggest advantage is having a single site so you don't need a separate account for the wiki and the forum, and the functionalities are also nicely integrated with the main site itself."
isSatoshi: false
tags:
  - "early-contributor"
  - "forum"
