...
description: "ec がスレッドを開始: Bitcoin 用 URI スキーム"
isSatoshi: false
tags: []
...
ビットコインアドレスは、例えばトレントの[マグネットリンク](http://en.wikipedia.org/wiki/Magnet_URI_scheme)のような [URI スキーム](http://en.wikipedia.org/wiki/URI_scheme)を実装することで改善できるだろう。
