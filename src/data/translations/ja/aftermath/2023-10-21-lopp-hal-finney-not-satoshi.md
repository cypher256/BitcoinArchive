...
ロップは、まさにこの時間帯に[サトシ・ナカモト](/BitcoinArchive/ja/participants/satoshi-nakamoto/)が[マイク・ハーン](/BitcoinArchive/ja/participants/mike-hearn/)とメールでやり取りしたり、トランザクションをブロードキャストしたりするなどして、ビットコインネットワーク上で活動していたと論じる。ロップは、レース時間内に該当するサトシからハーン宛のメールとビットコイントランザクションを特定し、同一人物が両方を同時に行うことは不可能だと結論づける。
...
*[編者注：アンディ・グリーンバーグの 2014 年 Forbes 特集[「Nakamoto's Neighbor」](/BitcoinArchive/ja/entries/aftermath/2014-03-25-greenberg-forbes-nakamotos-neighbor/) ではフィニー宅訪問の場でフランからレース当日の写真を見せられたことが報告されており、ビットコイン・インスティテュートはこの記事をその写真記録の早期報道として位置づける。ロップの 2023 年の分析は、タイムスタンプの表を明示し、独立した補強議論を加える形でこのタイミング問題を改めて検証している。両者は補完関係にある。グリーンバーグが人的・写真的な記録を表面化させ、ロップがタイムスタンプの議論を構造化された分析として定式化した。]*
...
ハル・フィニーはカリフォルニア州テンプルシティに約 10 年住んでいた。同地は、グリーンバーグの 2014 年記事の数週間前に [Newsweek がドリアン・ナカモトをサトシ候補として特定した](/BitcoinArchive/ja/entries/aftermath/2014-03-06-newsweek-dorian-nakamoto/)のと同じ町である。フィニーとドリアン・ナカモトが「数ブロック離れて」住んでいたという地理的偶然が、グリーンバーグの記事タイトルの由来であり、フィニーがそもそもサトシ候補として注目された理由の一部でもある。ロップの分析はこの偶然をあくまで偶然として扱い、この点は地理ではなく活動記録によって答えるべきだと論じる。

## 結論

ロップは、レース日のアリバイと補強証拠の組み合わせにより、フィニー = サトシ説は成立しない、と主張する。ロップの記事は代替候補を提示するものではなく、特定の身元仮説に対する集中的な反論である。
