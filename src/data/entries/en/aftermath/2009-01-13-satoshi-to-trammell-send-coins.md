...
Their subsequent correspondence also touched on the insecurities of sending bitcoin by IP address. Satoshi ultimately dropped the send-to-IP feature from the software entirely, partly informed by these discussions. The same by-hand, ask-and-receive distribution pattern recurred a month later, [when Michel Bauwens asked whether Bitcoin was operational and got an identical offer](/BitcoinArchive/entries/aftermath/2009-02-12-michel-bauwens-biography/).
