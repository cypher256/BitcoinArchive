---
title: "Bitcoin did not appear from nowhere — inheritance and invention"
...
1. **Used during development (primary-source-confirmed).** Satoshi was demonstrably aware of the reference and using its concepts while building Bitcoin. The August 20–22, 2008 email exchange between Satoshi and [Adam Back](/BitcoinArchive/participants/adam-back/) establishes Hashcash in this category.
...
The reuse-versus-invent question runs through several later readings: [the Wei Dai identity hypothesis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/) draws on the b-money row, [the Nick Szabo identity hypothesis](/BitcoinArchive/entries/analysis/2013-12-05-szabo-satoshi-identity-hypothesis/) applies the same reading to Bit Gold (a precursor the whitepaper does not cite, and so not a row above), and [the cypherpunk-independent-arrival analysis](/BitcoinArchive/entries/analysis/2008-10-31-cypherpunk-independent-arrival/) uses the Hashcash row to argue that Satoshi knew the precursor without belonging to the community around it. The primary sources behind those rows are the [Hashcash announcement](/BitcoinArchive/entries/aftermath/1997-03-28-adam-back-hashcash-announcement/) and [Adam Back's 1998 b-money critique](/BitcoinArchive/entries/aftermath/1998-12-06-adam-back-b-money-monetary-critique/); the same component breakdown without the citations is in the [how-bitcoin-works visual glossary](/BitcoinArchive/entries/analysis/2026-05-23-how-bitcoin-works-visual-glossary/).

<!-- entry-closing -->
Bitcoin's reference list looks like a family tree and reads, to me, like a bibliography assembled after the fact. The author wrote the code first and went looking for its ancestors afterwards, and found that the most important pieces had none.
