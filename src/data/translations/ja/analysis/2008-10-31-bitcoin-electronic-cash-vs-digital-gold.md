...
[デジタルゴールドの構造的特徴の分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-bitcoin-digital-gold-structural-features/)と[設計意図と現状の分析](/BitcoinArchive/ja/entries/analysis/2026-05-24-satoshi-design-vs-current-reality/)のあいだには、一つ問いが残る。その問いを、一次資料から読む。ビットコインを金にした性質と、その現金の使い道を奪った性質は、もとは一つだったのではないか。
