...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi reports checking in major v0.1.6 changes to SVN, including multi-proc generation, wallet.dat flushing, hiding non-accepted coins, and the disabled fee option."
isSatoshi: true
tags:
  - "early-contributor"
secondarySources:
