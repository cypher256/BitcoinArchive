...
これら二つの分析はいずれも、本 8 月 1 日フォークを自らの論証における決定的事件として扱う。 [ブロックサイズ戦争 2015〜2017 総括](/BitcoinArchive/ja/entries/analysis/2015-08-15-block-size-war-2015-2017-overview/)は本フォークを、チェーン合意ではなくチェーン分離による論争の終端決着として読む。 [ビットコインフォークおよびアルトコイン家系図分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/)は本フォークを家系図中に、 2017 年以後のチェーン分岐の起点となる 2017 年の分裂として置く。
