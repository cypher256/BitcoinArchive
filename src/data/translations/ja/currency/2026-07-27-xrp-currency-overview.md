...
一覧のうち二割未満が不正であっても合意は止まらない。裏を返せば、不正な取引を通すには一覧の八割超が結託しなければならない計算になる。検証者が規定数を割ってオフラインになれば、サーバーは定足数に届かず新しい版の確定を止める。ここに、検証者を誰が選ぶかという疑問が残る。既定の一覧を編んできたのは長らくリップル自身であり、2020 年 9 月 24 日に独立した非営利団体として XRPL 財団が 650 万ドルの寄付を受けて発足した後も、その役割の中心はリップルとこの財団に残ったままだ。2023 年 7 月時点で、レジャー自身のよくある質問ページによれば検証者の総数は 150 を超える。だが既定の一覧に載るのはそのうち 35 だけで、リップル自身が運営するのはその 35 のうちわずか 1 つに過ぎない。

同じ論点に対する答えは、五つの軸でことごとく食い違う。
...
XRP レジャーの供給曲線は平坦だ。ビットコインの 2,100 万枚が 33 回の半減を重ねながら 2140 年ごろまでかけて段階的に掘り出されるのに対し、XRP の 1,000 億枚はジェネシスの台帳の時点でもう全量が存在していた。

| 出来事 | XRP | ジェネシス供給に占める割合 | 時期 |
|---|---|---|---|
| ジェネシスで全量を生成 | 1,000 億 | 100% | 2012 年 6 月 |
| 新設会社へ贈与 | 800 億 | 80% | 2012 年 9 月 |
| 創設者 3 人が個人で保有 | 200 億 | 20% | 2012 年 9 月 |
| 55 件のエスクロー契約へ拠出 | 550 億 | 55% | 2017 年 12 月 |
| 取引手数料により累計消却 | 約 1,400 万 | 約 0.014% | 2012 年〜現在 |

2017 年、リップルは自社が保有する 550 億 XRP を、レジャーそのものが強制するエスクロー契約の連鎖に封じ込めた。契約は 55 か月にわたり、毎月 1 日に 10 億 XRP ずつを解放するよう組まれている。その月に使わなかった分は、行列の最後尾に新しいエスクローとして積み直される。結果として、毎月市場に新たに出回る量は額面の 10 億 XRP よりずっと少なく、おおむね 2 億から 3 億 XRP にとどまってきた。
...
| 時期 | 出来事 |
|---|---|
| 2020 年 12 月 22 日 | SEC がリップル・ラボ、ラーセン、ガーリングハウスを相手取り、2013 年以降の 13 億ドル超の XRP 売却について提訴 |
| 2023 年 7 月 13 日 | トーレス判事が、XRP 自体は証券ではないと判断。機関投資家向け販売は証券に該当し、匿名の買い手への取引所販売は該当しないとした |
| 2024 年 8 月 7 日 | 最終判決。1 億 2,500 万ドルの制裁金 (SEC が求めた額を大きく下回る) と、将来の無登録機関投資家向け販売を禁じる差止命令 |
| 2025 年 8 月 7 日 | SEC とリップルが双方の控訴を共同で取り下げ、訴訟が終結 |
