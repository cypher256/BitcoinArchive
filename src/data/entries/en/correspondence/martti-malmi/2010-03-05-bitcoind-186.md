...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi sends an improved fix for the ParseString bug using string::size_type and a cleaner loop structure to properly handle string::npos on 64-bit systems."
isSatoshi: true
tags:
  - "early-contributor"
  - "development"
