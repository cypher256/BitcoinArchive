...
The Popper / NYT 2015 article and Digital Gold remain, eleven years on, the highest-profile mainstream-press identification of Szabo as the likely Satoshi. The 2026 [John Carreyrou / NYT investigation](/BitcoinArchive/entries/aftermath/2026-04-08-nyt-carreyrou-adam-back-satoshi-investigation/) named [Adam Back](/BitcoinArchive/participants/adam-back/) as its leading candidate using a different methodology (large-population stylometric comparison with independent linguistic review). The two NYT identifications, separated by eleven years, name different candidates by different methods — both are denied by their named subjects.
