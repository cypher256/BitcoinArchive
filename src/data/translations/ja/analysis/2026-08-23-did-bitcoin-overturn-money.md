...
| 生成 AI（独立した 5 つ） | 動いた | 5 つの研究所の生成 AI が、それぞれ 1 回の質問で、満場一致でビットコインを選び、その構造的な理由は検証済みだった |
...
- アンテ (2020) が測定したのはビジネス・経済学分野の文献に限られる。貨幣理論という下位分野がビットコインを受けてモデルを改訂したかどうかには触れておらず、これはブロックチェーン研究が論文を基礎文献として扱っているかどうかとは、別の狭い論点である。
