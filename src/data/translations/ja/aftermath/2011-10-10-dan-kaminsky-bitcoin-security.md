...
*[補足：ダン・カミンスキーは 2011 年 8 月の Black Hat USA 2011（ラスベガス）でもビットコインの分析を発表した。同じ Black Hat の場で、3 か月前に亡くなった [レン・サッサマンへの ASCII アート追悼をビットコインのブロックチェーンに埋め込んだ件](/BitcoinArchive/ja/entries/aftermath/2011-07-30-len-sassaman-blockchain-tribute/) も別途公開している。2013 年には CoinDesk に対し「コア技術は実際に機能しており、誰もが予測したわけではない程度にまで機能し続けている」と語った。カミンスキーは 2008 年に重大な DNS 脆弱性を発見したことで有名だった。2021 年 4 月 23 日に亡くなった。]*
