...
- 1992 年から 2008 年頃までのサイファーパンクメーリングリスト 3 件の通信を収集：**Cypherpunks** リスト、**Cryptography** リスト（metzdowd.com）、**Hashcash** メーリングリスト。3 番目の Hashcash は**アダム・バック本人が 1997 年に提案した Proof of Work 方式の告知・議論リスト**であり、バックの執筆量がこのリスト上で構造的に多くなることは「バックがサトシかどうか」 とは無関係の事実である。バック側の公表反論はこれを方法論上の核心問題として位置づける。すなわち、10 年以上にわたるバックの大量執筆 (Hashcash・サイファーパンク両リスト) は、活動量の少ない寄稿者よりはるかに多くの材料をパターンマッチングシステムに提供するため、バックのコーパスへの最高一致は著者性の証拠ではなく執筆量の副産物にすぎない、とする立場である。
