...
sourceNote: "Tether's June 2016 whitepaper, 'Tether: Fiat currencies on the Bitcoin blockchain,' set out the original three-layer Bitcoin/Omni Layer design and named its own weaknesses two years into operation. Later specifics — reserve composition, freeze cases, regulatory settlements — are each drawn from their own primary source."
