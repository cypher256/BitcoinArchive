...
| 2010 年 12 月 3 日 | サトシ → マルッティ・マルミ「ギャビンが適任だ。彼は信頼できる。責任感があり、プロフェッショナルだ。Linuxに関しては、技術的に私よりずっと上だ。」 (アンドレセンが適任である理由として信頼性・責任感・プロフェッショナリズム・Linux 能力を挙げる) | [`mmalmi.github.io/satoshi` 公開メール](/BitcoinArchive/ja/entries/aftermath/2009-05-02-first-contact-satoshi-reply/) |
