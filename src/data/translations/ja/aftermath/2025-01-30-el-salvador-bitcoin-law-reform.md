---
title: "14 億ドルの IMF 融資と引き換えに義務撤廃、それでも止まらないビットコイン購入"
...
participants:
  - name: "Nayib Bukele"
    slug: "nayib-bukele"
description: "エルサルバドル議会が 55 対 2 でビットコイン受け入れ義務を撤廃、IMF 融資は公共部門の新規購入をゼロと定めたが政府は購入を続けた。"
isSatoshi: false
tags:
  - "el-salvador"
  - "imf"
...
secondarySources:
  ...
  - name: "IMF Press Release No. 24/485 (staff-level agreement, via El Salvador Now mirror)"
    url: "https://www.elsalvadornow.org/2024/12/19/imf-reaches-staff-level-agreement-with-el-salvador-on-an-extended-fund-facility-arrangement"
  - name: "IMF Press Release No. 25/043 (Executive Board approval, via El Salvador Now mirror)"
    url: "https://www.elsalvadornow.org/2025/02/27/imf-executive-board-approves-new-40-month-us1-4-billion-extended-fund-facility-arrangement-for-el-salvador/"
  - name: "IMF Press Release No. 22/13 (2021 Article IV consultation)"
    url: "https://www.imf.org/en/news/articles/2022/01/25/pr2213-el-salvador-imf-executive-board-concludes-2021-article-iv-consultation"
  - name: "Cointelegraph — IMF says no voluntary bitcoin accumulation by El Salvador's public sector"
    url: "https://cointelegraph.com/news/imf-el-salvador-no-voluntary-bitcoin-accumulation-public-sector"
  - name: "BitcoinTreasuries.net — El Salvador government holdings"
    url: "https://bitcointreasuries.net/governments/el-salvador"
  - name: "Yahoo Finance — El Salvador's rising bitcoin holdings under the IMF program"
    url: "https://finance.yahoo.com/markets/crypto/articles/el-salvador-claims-buying-bitcoin-102223005.html"
  - name: "Latin Counsel — Changes to El Salvador's Bitcoin Law"
    url: "https://www.latincounsel.com/?Noticias=Importantes_cambios_en_la_Ley_del_Bitcoin_de_El_Salvador_EN"
  - name: "Reason — El Salvador Walks Back Its Bitcoin Law"
    url: "https://reason.com/2025/02/03/el-salvador-walks-back-its-bitcoin-law/"
    note: "議会の 55 対 2 の採決を 2025年1月29日、官報公布の前日と記す。"
relatedEntries:
...
![ダークネイビーの背景に、割れた鎖の輪の上に押された立法の印章、天秤の片側にビットコインの記号、もう片側に小さな政府庁舎のアイコンを乗せた計り、金色の階段状に伸びる棒グラフとゼロを示す横線、そして国旗を思わせる隅の点線の縁取りを配したエディトリアル・インフォグラフィック。](/BitcoinArchive/images/analysis/2025-01-30-el-salvador-bitcoin-law-reform-hero.png)

55 対 2。これが、2025年1月29日にエルサルバドル議会が[ビットコイン法](/BitcoinArchive/ja/entries/aftermath/2021-09-07-el-salvador-bitcoin-law/)から強制受け入れの条項を削り取った採決の票差である。IMF が 2022年以来求め続け、4 週間後に理事会が承認する 14 億ドル融資の前提条件でもあった。義務を手放したはずの政府は、同じ融資条件が公共部門の新規購入をゼロに据え置くビットコインを、そのまま買い増し続けていた。エルサルバドルは、[およそ 30 の政府にわたるビットコイン政策転換をこのアーカイブが追う中の一件](/BitcoinArchive/ja/entries/analysis/2026-07-28-bitcoin-nation-state-policy-history/)である。

```mermaid
timeline
    2021 : ビットコイン法制定 ビットコインが法定通貨に(9月7日)
    %% link: /BitcoinArchive/ja/entries/aftermath/2021-09-07-el-salvador-bitcoin-law/
    2022 : IMF 第4条協議終了(1月24日)、 プレスリリースで 法定通貨の地位撤回を勧告(1月25日)
    2024 : IMF と14億ドルの EFF 交渉合意、 新規購入ゼロ条件含む(12月18日)
    2025 : 議会が 55対2で 強制受入義務を撤廃(1月29日)、 立法令第199号 として官報公布(1月30日)
         : IMF 理事会が14億ドルの EFF を承認(2月26日)
         : ブケレ氏が 購入発表、 保有 6,100 BTC に(3月3日)
    2026 : 政府保有が約7,723 BTC に到達(7月25日)
```
...
議会は 2021 年、法律に「法定通貨」という言葉を書き込んだ。そして 2025 年、その呼称の問題を直接扱った側の報道によれば、法令によってその言葉を取り消した。どちらの報道も争わないのは残高そのものだ。IMF 自身の条件が公にさせたウォレットアドレスは、誰でも確認できる状態にある。台帳は融資契約を参照してから送金を記録するわけではない。エルサルバドルが 2021年の法律で解決しようとした、[使える通貨と保有される資産の間の設計上の緊張](/BitcoinArchive/ja/entries/analysis/2008-10-31-bitcoin-electronic-cash-vs-digital-gold/)は、3年と一度の法改正を経てもなお、誰も大きさを争わない準備高をめぐって争われ続けている。
