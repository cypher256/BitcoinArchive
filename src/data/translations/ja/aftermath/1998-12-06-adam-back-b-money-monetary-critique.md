...
本批評がビットコインの設計にどうつながるかは、三つの分析でさらに掘り下げられている。[アダム・バック同定仮説](/BitcoinArchive/ja/entries/analysis/2026-04-08-adam-back-satoshi-identity-hypothesis/)は七つの論点それぞれを、後にビットコインがどう解決したかに対応付ける。[固定供給対調整可能通貨分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)は本批評を、ビットコインの固定供給選択に先立つサイファーパンクの貨幣論争の一部として読む。[サイファーパンク独立到達分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-cypherpunk-independent-arrival/)は中心提案 — CPU 時間を燃やして価値を創造する — を、サトシが独立に到達した PoW を価値に結びつける配置として読む。
