...
description: "2015 年 5 月 15 日、ニューヨーク・タイムズはナサニエル・ポパーによる「サトシ・ナカモトの謎とビットコイン誕生を読み解く」 を掲載した。本記事はポパーの著書『デジタル・ゴールド：マネー再発明を試みた変人と億万長者たちの内幕』（Harper、2015 年 5 月）からの抜粋で、サトシ候補に関する取材を読者に概観させた上で、サイファーパンク時代の暗号学者で Bit Gold を設計したニック・サボがサトシ・ナカモト仮名の中の人物として最も可能性が高いと結論づけた。取材中にポパーから接触されたサボは、メールで特定を否定した。本記事は現時点までで主流大手紙によるサボ＝サトシ特定として最も注目度が高いものであり、後続のジャーナリズムにおいてサボ＝サトシ仮説の最頻出参照源となっている。"
isSatoshi: false
tags:
  - "nick-szabo"
  - "satoshi-identity"
...
- **Bit Gold の概念的近接。** サボの Bit Gold 提案 — 計算的プルーフオブワークによる成果物の連鎖を、ビザンチン耐性のあるサーバー網で認証する設計 — は、公表されたあらゆる先行構想の中で、ビットコインの建築的問題空間を最も近く先取りしていた。ポパーは Bit Gold を「ビットコインに最も近い前駆」 と表現した。
