...
participants:
  ...
  - name: "Hal Finney"
    slug: "hal-finney"
description: "ビットコインが Hashcash スタイルの SHA-256 PoW（署名ではなく）を使うことをサトシが明確化。比例マイニング確率、アイデンティティ、二重支払い防止を説明。"
isSatoshi: true
tags:
  - "proof-of-work"
  - "hashcash"
...
<!-- speaker: Ray Dillinger -->
> 誰かが二重支払いを行った場合、そのトランザクション記録は
> ブラインドを解除でき、不正者の身元が明らかになる。
...
<!-- speaker: Ray Dillinger -->
> もし二重支払いが含まれていれば、二重支払いの証拠となる
> 「トランザクション」を作成し、自分のプール A に追加して
> ブロードキャストし、作業を続ける。
...
<!-- speaker: Ray Dillinger -->
> CPU 集約型のデジタル署名アルゴリズムで
> 新しいブロック L を含むチェーンに署名する。
...
> 誰かが単一額面のコイン 10枚を引退させ、
> 額面 10 の新しいコイン 1枚を作成する「証明可能な」
> トランザクションが必要だ。
