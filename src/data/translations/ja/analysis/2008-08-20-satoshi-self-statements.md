...
| 「コーディングしながらこの 1 年半でそれらの細かい詳細をすべて検討してきた」 | [cryptography メーリングリスト 2008-11-17](/BitcoinArchive/ja/entries/emails/cryptography/bitcoin-p2p-e-cash-paper/2008-11-17-bitcoin-p2p-e-cash-paper/) | 2008-11-17 | 約 18 か月のコーディング期間を述べる。 逆算するとコーディング開始は 2007 年半ば頃。 より広い設計期間 (サトシが後に「2007 年から」 と述べたもの) は §2.2 で別途整理 |
...
| 「私も今は大して役に立てない、 仕事で忙しく、 18 か月の開発の後で休みが必要だ」 | [→ マルティ・マルミ 2009-07-21](/BitcoinArchive/ja/entries/correspondence/martti-malmi/2009-07-21-bitcoin-024/) | 2009-07-21 | 「18 か月の開発」 と述べる (この phrase が示す範囲がコーディング期間と一致するかは表現上開いている)。 疲労の自己開示 (同メール直前の文はハル・フィニーの活動低下を述べており、 サトシの「私も」 が自身の状態への転換となる) |
...
- **期間**。 D6 と D7 は「1 年半」「18 か月」 を同時期にほぼ近接して述べ、 D11 は「2 年」 を事後的に述べ、 D8 / D9 / D10 は作業の一部をさらに過去に位置づける。 これらを単一の基準となる数値に統合するのは、 サトシが異なる文脈・異なる時期に用いた表現を混同することになる。 保守的な読みは、 サトシが同時期に言及したコーディング期間 (D6, D7) が 2007 年半ばから v0.1 リリース付近までおおむね走り、 設計作業は後の枠付け (D8, D9, D11) によれば 2007 年内のより早い時点で始まり並行して走っていた、 というもの
- **設計とコーディングの区別**。 D9 がこの 2 つを明示的に区別する唯一の発言。 「1.5 年のコーディング」 と「2 年の開発」 を単一の時間軸数値に統合しない、 基準となる理由がここにある
...
- 「1 年半」 のタイムライン (cryptography メーリングリスト 2008-11-17 + マルミ 2009-07-21) は、 2007 年半ばから 2009 年 1 月の v0.1 リリース付近までの約 18 か月のコーディング期間を示す。 サトシは後に、 そのコーディングを内側に含むより広い設計期間についても語っている: 「2007 年から。 …作業の大部分は設計であり、 コーディングはそれより少なかった」 (BitcoinTalk でのラズロ・ハニエツへの返信、 2010 年 6 月 18 日)、 「このプロジェクトはリリース前に 2 年間の開発を要した」 (マイク・ハーン宛メール、 2011 年 1 月 10 日)。 コーディング期間と設計期間はいずれもサトシ本人の枠付けであり、 1 つの数値に統合するのは別の 2 つの期間を混同することになる。
...
- 実装作業のタイムライン: おおむね 2007 年半ばから 2008 年 8 月まで (これは公開前の設計期間全体より狭く、 サトシが後に「2007 年から」「リリース前に 2 年間の開発」 と述べたより広い枠の内側にある)
