...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Malmi asks Satoshi for MySQL database credentials to set up WordPress on the SourceForge site, and responds to Satoshi's feedback on the FAQ and wallet security."
isSatoshi: false
tags:
  - "correspondence"
  - "early-contributor"
