---
title: "ピーター・トッドが OpenTimestamps を発表"
...
<!-- speaker: narrator -->
- **トラスト最小化：** 中央当局への依存なしに、ビットコインの公開監査可能なブロックチェーンが時間証明として機能する
...
<!-- speaker: narrator -->
*[編者注：OpenTimestamps は、サトシがビットコイン自体に組み込んだ核心的な洞察を反映している。ブロックチェーンは本質的にタイムスタンプシステムであるということだ。ビットコインホワイトペーパーのタイトルは「P2P 電子キャッシュシステム」だが、セクション 3 のタイトルは「タイムスタンプサーバー」である。トッドのプロジェクトはこのタイムスタンプ機能を抽出し、任意のデータに対して一般化したものだ。]*
