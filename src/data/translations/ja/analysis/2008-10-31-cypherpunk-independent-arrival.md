...
サトシは自身のビットコイン作業の期間に公開記録上で何度か触れている。そのうち 2 つはコーディング期間の枠付けである。
...
| 2. コードを書くことが行動 | コード先行リリース、その後で説明する流れ。ホワイトペーパー告知は v0.1 の動作バイナリへ直接リンク。後の修正もコードとして出荷した。声明として出したのではない | [v0.1 リリース投稿 2009-01-08](/BitcoinArchive/ja/entries/emails/cryptography/bitcoin-v0-1-released/2009-01-08-bitcoin-v0-1-released/)、v0.1.2 修正告知 2009-01-11 |
