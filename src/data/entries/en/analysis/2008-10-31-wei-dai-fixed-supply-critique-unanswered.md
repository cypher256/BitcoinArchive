...
Wei Dai's name sits in Bitcoin's whitepaper as reference [1], and his verdict on its monetary policy has traveled for over a decade as a credentialed dissent — the precursor's own author, saying the successor got it wrong. That reference was added after Satoshi's code was already substantially complete, not because b-money shaped Bitcoin's design. The credential is real regardless. The dissent rests on a mechanism its own designer never finished building, for a reason its own designer named on the record within ten days of proposing it. Satoshi's answer to "why not something smarter" was "because I don't know how." Fifteen years on, neither did the person asking the question.
