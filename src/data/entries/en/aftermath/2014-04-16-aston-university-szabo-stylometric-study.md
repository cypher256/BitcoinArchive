...
This Aston University study is treated as one of the load-bearing stylometric pillars by [the Nick Szabo identity hypothesis](/BitcoinArchive/entries/analysis/2013-12-05-szabo-satoshi-identity-hypothesis/). The hypothesis references this study as the academic, quantitative corroboration independent of Skye Grey 2013 that ranked Szabo highest among 11 candidates, returning to it across its supporting-evidence sections as part of the documented forensic-fit signal the entry's argument turns on.
