...
## Prior to SVN
Satoshi Nakamoto distributed Bitcoin's source code as `.rar` archives on SourceForge before the SVN repository existed. The SourceForge project was [registered on November 9, 2008](/BitcoinArchive/entries/aftermath/2008-11-09-bitcoin-project-registered/), and Bitcoin v0.1 was [released on January 9, 2009](/BitcoinArchive/entries/aftermath/2009-01-09-bitcoin-v01-released/). For the first eight months, source code was distributed as downloadable archives rather than through version control.
