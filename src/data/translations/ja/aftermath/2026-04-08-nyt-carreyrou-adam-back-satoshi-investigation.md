...
description: "2026 年 4 月 8 日、ニューヨーク・タイムズはピューリッツァー賞受賞ジャーナリストのジョン・カレイロウによる調査記事を掲載し、アダム・バックがサトシ・ナカモトの仮名の中の人として最も可能性が高いと結論づけた。本調査は 18 か月にわたって NYT の AI 専門家のディラン・フリードマンと協働で実施され、1992〜2008 年のサイファーパンクメーリングリスト 3 件のアーカイブを文体計量分析にかけ、ビットコイン以前の暗号学メーリングリストに 10 件以上投稿した 620 人の書き手のうちで、バックがサトシの文体に最も近い一致を示した。委託先の言語学者のフロリアン・カフィエロによる独立分析は、12 名の候補のうちバックを最上位に位置づけたが、結果は不確定であり、ハル・フィニーがほぼ並んだと述べた。バックはエルサルバドルでの 2 時間の対面インタビューでカレイロウに対し 6 回以上にわたって正体を否定し、記事公開後の複数のインタビューで否定を繰り返した。"
isSatoshi: false
tags:
  - "adam-back"
  - "satoshi-identity"
...
- 1992 年から 2008 年頃までのサイファーパンクメーリングリスト 3 件の通信を収集：**Cypherpunks** リスト、**Cryptography** リスト（metzdowd.com）、**Hashcash** メーリングリスト。3 番目の Hashcash は**アダム・バック本人が 1997 年に提案した Proof of Work 方式の告知・議論リスト**であり、バックの執筆量がこのリスト上で構造的に多くなることは「バックがサトシかどうか」 とは無関係の事実である。バック自身もこれを方法論上の核心問題として指摘している：「私は電子通貨について 10 年以上にわたって膨大な量を書いてきた。私のアーカイブ済み執筆は、活動量の少ない寄稿者よりはるかに多くの材料をパターンマッチングアルゴリズムに提供する。一致は著者性ではなく分量の副産物である。」
