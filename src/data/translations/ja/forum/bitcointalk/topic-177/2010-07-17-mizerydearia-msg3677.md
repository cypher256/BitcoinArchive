...
>
> 電話はコンピュータよりはるかに身近で広く普及している。電話しか持っていない人もたくさんいる。
>
> SMS／ゲートウェイ／鍵交換のような何かでもいい……たとえば非対応の電話からゲートウェイサーバ経由で対応の電話にSMSで支払いを送ったり、トランザクションを処理してくれる信頼できるサードパーティに送ったりできるようになる。
> たぶんローリングパスコードを使ってだ。
>
