...
This long-horizon analysis is read against several adjacent records. [The fixed-supply-vs-adjustable-money analysis](/BitcoinArchive/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/) treats the fee-only horizon analyzed here as the post-issuance counterpart of the fixed-supply argument — the question the 21-million cap forces the network to answer eventually. [The Satoshi-design-vs-current-reality analysis](/BitcoinArchive/entries/analysis/2026-05-24-satoshi-design-vs-current-reality/) uses the same horizon to frame the long-term divergence between what Satoshi committed the network to and what later operators built on top of it. [The how-bitcoin-works visual glossary](/BitcoinArchive/entries/analysis/2026-05-23-how-bitcoin-works-visual-glossary/) is the reader-facing layer that summarises the same arithmetic without the citations. The technical anchor sits in the design corpus: both the [consensus](/BitcoinArchive/entries/design/2009-01-03-bitcoin-consensus-design/) and [monetary](/BitcoinArchive/entries/design/2009-01-03-bitcoin-monetary-design/) design entries depend on the fee-market transition as a load-bearing assumption, and this analysis is the entry that examines whether the assumption holds. The price side of the same miner economics — how production cost and market price interact while the subsidy still dominates — is treated in [the price-vs-production-cost analysis](/BitcoinArchive/entries/analysis/2010-02-21-bitcoin-price-vs-production-cost/).
