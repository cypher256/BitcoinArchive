...
10 人の名指し候補、サトシの公的記録から導かれる 7 つの次元。どの候補も 7 つすべてに合致しない —— それぞれが少なくとも 1 つの次元で破綻する。本エントリは名指し候補を 1 枚のプロフィール表で並列比較する —— Hashcash の引用知識、2008 年 8 月のアダム・バックとウェイ・ダイとの公開前通信、ウェイ・ダイの 2014 年「以前活動していなかった」 識別性論、19,901 行の v0.1 C++ コードベース、ネイティブ級の英語、18 か月の集中開発期間、2011 年 4 月の撤退 —— そして各プロフィールがどこで破綻するかを記す。各候補は以下のサトシに関する公的記録から導出される輪郭に照らして測られる：
