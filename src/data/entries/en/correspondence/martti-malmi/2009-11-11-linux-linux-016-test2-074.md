...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi releases linux-0.1.6-test2 with fixes for socket error handling, an inactivity timeout fallback, and a partial fix for slow initial block downloads."
isSatoshi: true
tags:
  - "early-contributor"
  - "linux"
...
linux-0.1.6-test2.tar.bz2  12,134,012 bytes<br>
Download:<br>
