...
本通信記録は[ラズロ・ハニエツ伝記](/BitcoinArchive/ja/participants/laszlo-hanyecz/)によって根拠的な一次証拠として扱われる。同伝記は、ピザの日以前のハニエツによる macOS 移植および GPU マイニング貢献の語りを、本エントリに記録されたサトシの指示を土台として展開する。
