...
*[補足：本アーカイブにはルルーの dedicated エントリー（伝記・E4M 告知・刑事事件文書・Mastermind 関連）がまだ存在しない。以下の概略は外部ソース — 主にジャーナリスト Evan Ratliff の『The Mastermind』（Random House、2019 年）および Atavist の長編記事 — と公開記録に基づく。具体的な日付や記述はアーカイブ検証ではなく外部由来として扱われたい。]*
