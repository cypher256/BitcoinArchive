---
title: "Decoding the Enigma of Satoshi Nakamoto and the Birth of Bitcoin — Nathaniel Popper / New York Times investigation naming Nick Szabo (May 15, 2015)"
date: 2015-05-15T00:00:00Z
type: "article"
source: "new-york-times"
sourceUrl: "https://www.nytimes.com/2015/05/17/business/decoding-the-enigma-of-satoshi-nakamoto-and-the-birth-of-bitcoin.html"
...
secondarySources:
  ...
  - name: "Digital Gold: Bitcoin and the Inside Story of the Misfits and Millionaires Trying to Reinvent Money (Harper, May 2015)"
    url: "https://www.harpercollins.com/products/digital-gold-nathaniel-popper"
  - name: "The Guardian — Bitcoin's creator may be Nick Szabo, says new claim (March 2014, prior identification by Skye Grey)"
...
- **Bit Gold conceptual proximity.** Szabo's Bit Gold proposal — a chain of computational proof-of-work artifacts authenticated by a Byzantine-fault-tolerant network of servers — anticipated the architectural problem space of Bitcoin more closely than any other published precursor. Popper described Bit Gold as "the closest precursor to Bitcoin."
...
*[Context: The Popper / NYT 2015 article and Digital Gold remain, eleven years on, the highest-profile mainstream-press identification of Szabo as the likely Satoshi. The 2026 [John Carreyrou / NYT investigation](/BitcoinArchive/entries/aftermath/2026-04-08-nyt-carreyrou-adam-back-satoshi-investigation/) named [Adam Back](/BitcoinArchive/participants/adam-back/) as its leading candidate using a different methodology (large-population stylometric comparison with independent linguistic review). The two NYT identifications, separated by eleven years, name different candidates by different methods — both are denied by their named subjects.]*

For the analytical treatment of the Nick Szabo = Satoshi hypothesis (Popper's evidence weighed against the April 2008 implementation request, the May 2011 third-person framing, the continuous Unenumerated visibility throughout 2007–2008, and Szabo's repeated denials), see the [Nick Szabo = Satoshi identity hypothesis entry](/BitcoinArchive/entries/analysis/2013-12-05-szabo-satoshi-identity-hypothesis/).
