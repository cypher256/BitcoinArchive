...
サトシの最後の文書化された通信からサッサマンの死まで 3 か月。仮説はこれを、2010 年半ばから始まった撤退の終結として読み、4 月 26 日のメールを実際の終わりの前の最後の事務的な引き継ぎとして位置づける。Bitcoin Institute 自身が提起する反論：3 か月は短い間隔ではあるが極端に短いわけではなく、人は人生を変える出来事の数か月前に、その出来事と無関係な理由で大きなプロジェクトから手を引くことがよくある。
