...
サトシ・ナカモトとは誰なのか。どこから現れ、どこへ消えたのか。ハロウィンの夜、記録は九ページの白書と身元不明の名前から始まり、コード、通信、そして長い沈黙を残した。その空白のまわりに、十二人の名前が置かれてきた。名前が呼び起こす印象だけでは、身元は定まらない。知的系譜、文体、直接通信、実際に組み上げられたシステムという四つの記録を重ねたとき、どの名前がどこまで残るのか。
