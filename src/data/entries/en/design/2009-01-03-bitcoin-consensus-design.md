...
secondarySources:
  - name: "Bitcoin BIP 54 — Great Consensus Cleanup"
    ...
    note: "Proposed soft-fork mitigations for the time-warp vulnerability and related consensus issues."
relatedEntries:
...
Three neighbouring pages take the consensus rules from different sides. [The P2P network design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-p2p-network-design/) covers the transport that carries them. [The monetary design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-monetary-design/) covers issuance and difficulty as monetary policy rather than as validation. And [the security-model deep dive](/BitcoinArchive/entries/design/2009-01-03-bitcoin-security-model/) covers what happens when the rules are attacked — double-spend mitigation, 51% economics, selfish mining.
