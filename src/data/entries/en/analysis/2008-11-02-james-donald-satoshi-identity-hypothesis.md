...
description: "The hypothesis that James A. Donald — first to respond to the Bitcoin white paper — was Satoshi. A stylometric lead drew Benjamin Wallace to him, who then excluded Donald in person on character."
isSatoshi: false
tags:
  - "satoshi-identity"
  - "james-donald"
...
This hypothesis entry is referenced from the [James A. Donald biography](/BitcoinArchive/participants/james-donald/) (the subject of the hypothesis) and the [Satoshi-identity hypotheses overview](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/), which places James A. Donald in its Group C taxonomy within the necessary-but-not-sufficient evaluation framework.
