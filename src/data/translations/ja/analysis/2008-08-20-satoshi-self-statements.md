---
title: "サトシの自己言及と運用上の自己開示 — 一次資料の整理（2008-2011）"
...
公開記録には、サトシが Bitcoin を作った *理由* についての自己言及がほとんど含まれていない。最も近いのは P2P Foundation 紹介の制度的信頼への対立的枠組み（「中央銀行は通貨を毀損しないと信頼されなければならない」）と、特定の設計トレードオフについての BitcoinTalk での散発的言及である。本人によるより広いマニフェストは存在しない。
