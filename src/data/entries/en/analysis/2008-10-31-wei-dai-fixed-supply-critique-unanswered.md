...
The verdict has circulated for over a decade as evidence that Bitcoin's most-cited precursor thought fixed supply was a mistake. What it leaves out is the six months earlier in 2009 where Satoshi explained, in his own words, exactly why he never attempted the alternative — and what happened to that alternative when Dai himself proposed it, ten years before Bitcoin existed.
...
That does not make Dai's diagnosis of Bitcoin's volatility wrong; the price swings he named are real, and traced further in [the fixed-supply-vs-adjustable-money analysis](/BitcoinArchive/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/), which surveys fifteen years of cryptocurrency supply designs against Bitcoin's cap without taking a side on which is correct. What it does mean is narrower and more specific: the 2013 verdict carries the weight of an implemented, working alternative that could have been chosen instead. The record does not support that weight. B-money's own mechanism needed the same thing Satoshi said he didn't know how to build, and the one person positioned to demonstrate otherwise never did.

## What this does not show

This entry does not establish that a decentralized real-world-value oracle is impossible, only that none existed when Dai made either statement — in 1998 when he designed b-money, or in 2013 when he judged Bitcoin's design decision against it. Later cryptographic and oracle-network research is out of scope here. Nor does it settle whether fixed supply was the right call: that Satoshi lacked an answer to the elastic-supply problem explains why he chose a fixed schedule; it does not, by itself, prove the fixed schedule was correct on other grounds. And Dai's own account gives an independent, non-technical reason he stopped working on b-money — he says he had grown "disillusioned with cryptoanarchy" by the time he finished writing it up — so the unsolved mechanism was not necessarily the only reason the design went no further.
