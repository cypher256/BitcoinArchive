...
<!-- speaker: narrator -->
また、ビットコインアドレスへの送金は受信者が発見できるようにトランザクションをブロックチェーンに記録する仕組みであることを確認し、ウォレット暗号化を将来の機能として言及した ―― この案は後に、[マルッティ・マルミが 4 か月後に独立に提案した際](/BitcoinArchive/ja/entries/aftermath/2009-05-03-malmi-agrees-to-help/)にサトシが「絶対に不可欠」として支持することになる。
