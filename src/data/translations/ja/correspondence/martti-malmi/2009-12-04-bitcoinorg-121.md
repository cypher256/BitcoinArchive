...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "サトシがフォントレンダリング、v0.2 のトランザクション手数料ポリシーの変更、手数料計算を誤る CreateTransaction のバグについて議論。"
isSatoshi: true
tags:
  - "correspondence"
  - "early-contributor"
...
<!-- quote: q1 -->
<!-- tone-skip -->
>> フォントのアンチエイリアスが効かないのはどのWindowsバージョン/ブラウザーですか？
...
色の調整を続けられるように、とりあえずテキストに戻した。Drupal がブラウザーのタイトルに<span>タグなどのゴミを入れるが、テスト中は問題ない。
