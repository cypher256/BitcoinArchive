...
「Psiphonは、インターネットの検閲に使われるコンテンツフィルターリングシステムを安全にバイパスするために設計されたウェブプロキシだ。Psiphonはトロント大学のCitizen Labによって開発された。
...
Torプロジェクもサーバーオペレーター向けの決済/インセンティブシステムを探していると理解している。😊
