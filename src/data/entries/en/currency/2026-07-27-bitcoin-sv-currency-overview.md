...
sourceNote: "en.wikipedia.org/wiki/Bitcoin_SV is used here as the entry's canonical point of entry. Individual claims about the Genesis upgrade, supply, consensus, and the 2021 attacks are each sourced to the primary announcement, wiki, or news report listed under secondarySources."
