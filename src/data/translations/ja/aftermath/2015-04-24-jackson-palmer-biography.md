...
このアーカイブにおけるパーマーの記録は、公開そのものではない。その後に続いた一連の公の否認にある ─ 界隈に入って一年目から、2021 年の範疇そのものの拒絶まで ─ そしてその七年のあいだ、立場がほとんど動かなかったことにある。
...
このアーカイブはこの発言を記録し、その当否を裁定しない。切り出しておく価値があるのは技術に関わる節のほうだ。そこは政治ではなく特定の設計判断についての主張だからである。「人為的に強制された希少性」とは 2,100 万枚の上限のことであり、パーマーは、固定供給が価値の毀損に対する防御ではなく富の集中の仕組みとして働いていると主張している。[固定供給と自動調整の比較](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)は、同じ設定値についての二つの読みを両方並べており、そこでも問いを閉じていない。
