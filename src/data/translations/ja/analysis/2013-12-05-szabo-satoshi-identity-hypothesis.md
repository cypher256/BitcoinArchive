...
本ニック・サボ同定仮説は二つの隣接記録に錨を下ろされている。 [TechCrunch Skye Grey 文体計量報道](/BitcoinArchive/ja/entries/aftermath/2013-12-05-techcrunch-skye-grey-szabo-stylometric/)は本仮説が立脚する、最初に置かれた根拠的な文体計量の柱を提供する。 [サトシ同定仮説総覧](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/)は本仮説を Group B 分類に置き、「必要だが十分でない」評価枠組み内の主要比較錨の一つとして用いる。
