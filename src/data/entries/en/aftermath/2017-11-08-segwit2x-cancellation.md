...
Belshe's mailing-list post is the literal end of the New York Agreement. The signatures on the cancellation message are not all of the original NYA signers, but the absence of a contradicting signed message from any other signer functioned as a community-wide acceptance of the cancellation. The cancellation's place in the war's phases and factions is covered in [the block-size war overview](/BitcoinArchive/entries/analysis/2015-08-15-block-size-war-2015-2017-overview/); the wider fork-and-altcoin tree is in [the Bitcoin family-tree analysis](/BitcoinArchive/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/).

This November 2017 cancellation is treated by [the block-size war 2015–2017 overview](/BitcoinArchive/entries/analysis/2015-08-15-block-size-war-2015-2017-overview/) as the literal end of the New York Agreement and one of the war's defining phase transitions within its documented reconstruction of the conflict.
