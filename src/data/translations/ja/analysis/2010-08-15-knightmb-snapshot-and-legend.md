...
本アーカイブの [knightmb 伝記](/BitcoinArchive/ja/participants/knightmb/)は保守的な表現を維持している——「彼の本名は公に開示されていない」。本セクションの内容は文脈として提示するものであり、追認ではない。状況証拠の連鎖が同定として成立するに足る強度を持っているか、それとも——「10% 保有」 の場合のように——二次情報の収束が一次情報の証拠を追い越しているのか。
