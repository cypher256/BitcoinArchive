...
- この順次スキャンにより、ブロック解として選択されるナンスに **78%の高値バイアス** が生じた。これは、48 台以上の独立したマシンがそれぞれランダムな範囲をスキャンする場合とは整合しない統計的指紋である
...
1. **ナンス分布** ：サブレンジ内の 78%の高値バイアスは順次スキャンを必要とする。独立したマシンがそれぞれランダムな範囲をスキャンしていれば、50%の分布になっていたはずである
