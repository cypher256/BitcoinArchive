...
このリリースはv0.3.18からわずか数日後に行われ、サトシの最後の既知の公の通信の直前であった。12月12日、サトシはBitcoinTalkフォーラムに最後の投稿を行った。2011年1月半ばまでに、サトシはソースリポジトリとネットワークアラートキーをギャビン・アンドリーセンに引き渡し、最後の既知のメールは2011年2月22日にマルッティ・マルミに送信された後、完全に公の通信から姿を消した。
