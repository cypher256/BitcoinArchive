---
title: "Wired と Gizmodo がクレイグ・ライトをサトシ・ナカモトの可能性があると特定"
...
![WIRED と Gizmodo、二つの画面に同じサトシ・ナカモト説の見出しが並び、その下に流出したメールや会計書類の束、オフィス前に停まったパトカー、2008 年の日付に赤い×印が入ったブログ記事のアイコンが描かれたイラスト。](/BitcoinArchive/images/analysis/2015-12-08-wired-gizmodo-craig-wright-claims-hero.png)

2015年12月8日、Wired と Gizmodo は同時に、オーストラリアのコンピューター科学者で実業家の[クレイグ・スティーヴン・ライト](/BitcoinArchive/ja/participants/craig-wright/)を、ビットコインの創設者である[サトシ・ナカモト](/BitcoinArchive/ja/participants/satoshi-nakamoto/)の可能性が高い人物として特定する調査記事を掲載した。

Wired の記事はアンディ・グリーンバーグが執筆し、「ビットコインの創設者サトシ・ナカモトはおそらくこの無名のオーストラリア人の天才」と題されていた。記事は、流出したメール、会計記録、ブログ記事、その他の文書を証拠として提示し、ライトがビットコインの創設に関与していたことを示唆していた。2013年に死去したアメリカのコンピューターフォレンジック専門家、デイブ・クレイマンとライトが共同で開発した可能性も示唆された。

Gizmodo のサム・ビドルによる記事も同様の証拠を提示しており、ライトのメールアカウントにアクセスしたハッカーから入手したとされていた。証拠には、対話記録とされるもの、ビットコイン信託に関連する法的文書、そしてライトをビットコインの初期開発の中心に位置づけるようなやり取りが含まれていた。
