...
sourceNote: "This entry synthesizes figures already sourced and dated in this archive's ownership map and nation-state policy survey (linked below) with new research into the academic and economics-establishment record. Each new claim carries its own citation and date."
...
secondarySources:
  - name: "Paul Krugman — 'Is This Crypto's Fimbulwinter?' (Substack, Feb 5, 2026)"
    ...
    note: "Krugman's own words, not a paraphrase. Nobel Memorial Prize in Economic Sciences, 2008 — the same year the Bitcoin whitepaper was published."
  - name: "Chicago Booth Review — Capitalisn't: Why This Nobel Economist Thinks Bitcoin Is Going to Zero"
    ...
    note: "Eugene Fama, Capitalisn't podcast, Jan 30, 2025. Fama won the Nobel Memorial Prize in Economic Sciences in 2013."
  - name: "Ante, L. — 'A place next to Satoshi: foundations of blockchain and cryptocurrency research in business and economics' (Scientometrics, 2020)"
    ...
    note: "467 articles and 9,672 references from the Web of Science Core Collection, analyzed by factor and social-network analysis."
  - name: "Blockchain Research Lab — summary of Ante (2020)"
...
inlineLinkKeywords:
  - "next to Nakamoto (2008)"
---

![Split illustration on a dark background: on the left, a rising bar chart of institutional Bitcoin holdings in gold; on the right, two grey portrait silhouettes labeled with question marks facing away from a small glowing coin, suggesting economists turned away from it.](/BitcoinArchive/images/analysis/2026-08-23-did-bitcoin-overturn-money-hero.png)
...
timeline
    ...
    2024 : US spot ETFs approved (Jan)
    2025 : Fama - probability of zero is "close to one" (Jan 30)
         : US Strategic Bitcoin Reserve established (Mar 6)
