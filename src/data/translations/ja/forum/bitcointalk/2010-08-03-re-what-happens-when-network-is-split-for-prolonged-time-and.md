...
> [Quote from: gavinandresen on August 03, 2010, 06:38:44 PM](https://bitcointalk.org/index.php?topic=661.msg7293#msg7293)あるいは分断が十分長く続いた場合（100ブロック以上）、短い方のチェーンで生成されたコインを含むトランザクションは、マージ時に無効になります。
