...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi reports that test5 solved the zombie socket problem via MSG_DONTWAIT, but a Berkeley DB exception on 64-bit Linux remains, and asks Malmi to help test."
isSatoshi: true
tags:
  - "correspondence"
  - "early-contributor"
...
************************
EXCEPTION: 11DbException<br>
Db::open: Bad file descriptor<br>
bitcoin in ThreadMessageHandler()<br>
************************<br>
EXCEPTION: 11DbException<br>
Db::close: Bad file descriptor<br>
