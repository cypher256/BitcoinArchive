...
<!-- speaker: narrator -->
BIP 65 はコンセンサースレベルのソフトフォークとしてデプロイされた。より高度なビットコインスマートコントラクトの構成要素の一つであり、後に Lightning Network を支えるペイメントチャネルの基盤となった。BIP 125（Replace-by-Fee）と並んで、ピーター・トッドのビットコインプロトコルへの最も重要な貢献である。
