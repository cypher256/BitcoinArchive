...
1. **P異常（拡張Patoshi異常）：** ブロックノンスの最初の16進ニブルが、0〜Fに一様分布するはずのところ、0〜3の範囲に不均衡に多くの値を示す。これはラーナーのオリジナルの[ノンスLSB分析](/BitcoinArchive/ja/entries/aftermath/2013-09-03-sergio-lerner-nonce-lsb-discovery/)の拡張と形式化である。
