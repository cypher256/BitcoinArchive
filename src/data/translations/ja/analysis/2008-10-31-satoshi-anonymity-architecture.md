...
あらゆるサトシ正体仮説は、独立した 6 層の非特定化を同時に整合させなければならない。具体的には、日本人風の仮名、タイムゾーンを跨ぐ投稿パターン、英国式英語の書き言葉、匿名リレーメール基盤（AnonymousSpeech.com、vistomail.com）、数年間の通信で一度も IP が漏れない事実、段階的（突発的でない）撤退の 6 点である。本エントリは「サトシ・ナカモト」という仮名が、開発期間（2007 年中頃〜2008 年 8 月）・公の活動期間（2008 年 10 月〜2010 年 12 月）・撤退期間（2010 年 9 月〜2011 年 4 月）を通じて身元を特定されないでいる手段を、公開記録から観察可能な痕跡として 6 層に組織化する。

本エントリは「サトシはどう匿名であり続けたのか」に答える。隣接する 2 つの問いは別エントリが扱う: [身元仮説総覧](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/)（「サトシは誰か」）と[識別の非対称性](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identification-asymmetry/)（「これだけの材料があるのになぜ不明状態が続くのか」）。
...
| 日付 (UTC) | 出来事 | 出典 |
|---|---|---|
| 2010 年 9 月 | サトシ → ギャビン・アンドレセンへメール「他のプロジェクトに取り組んでいる」。具体的な日付・媒体は公開記録になく、アンドレセンの後年の回想からの再構成。 | ギャビン・アンドレセンのインタビュー (CoinMarketCap「Satoshi Files: ギャビン・アンドレセン」) |
...
| 2010 年 12 月 12 日 | サトシ → アンドレセン、SourceForge リポジトリへのコミット権を正式譲渡 (メール)。同日公開側: BitcoinTalk の DDoS 緩和スレッドにて最終公開投稿、結びは「あといくつかのことを行ったら、バトンを渡す予定だ。」 | COPA v Wright 公開証拠資料、[BitcoinTalk スレッド](/BitcoinArchive/ja/entries/forum/bitcointalk/topic-2228/2010-12-12-satoshi-final-post/) |
