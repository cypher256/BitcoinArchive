...
仮説の主張は、サッサマンがサトシ・ナカモトの仮名の中の人物だったというもの。彼は死の少し前にプロジェクトから退き、[2011 年 4 月 26 日のギャビン・アンドレセン宛て最終メール](/BitcoinArchive/ja/entries/aftermath/2011-04-26-satoshi-to-andresen-alert-key/)（サッサマン自殺の 3 か月前）が、複数の同時並行プロジェクトから一歩離れる動きではなく、彼のビットコインとしての人生を閉じる動作だった、というのがこの仮説の構造である。
...
| 反証 | 中心観察 | 強度の評価 |
|---|---|---|
| §3.1 直接的な文書上の繋がりの不在 | サッサマン↔サトシ間の通信、共同コミット、ビットコイン関与の痕跡が公開コーパスに皆無 | 仮説の最も強い反証 — 仮説の維持にはすべてが公開記録の外で起きた必要がある |
| §3.2 2011 年以降の証拠問題 | 離脱後のサトシ名義の事象は 2 件のみ —— 2014 年 3 月の P2P Foundation 投稿とバウエンスの 2025 年の回想 —— で、真正ならサッサマンを除外するが、孤立し、相互裏付けも署名もなく、真偽が争われている | 唯一の識別脚であるタイミング論に直接効くが、証拠が薄く、サッサマンの死後にサトシが活動したかを確定できない —— タイミング論を確定も否定もしない |
| §3.3 KU Leuven の負担 | サッサマンは 2008–2011 年に KU Leuven COSIC の PhD 候補生で、ビットコインの約 18 ヶ月の集中開発期間と重複 | 可能だが負担増大 — 完全否定ではない |
| §3.4 パターソンの沈黙 | サッサマンの妻メレディス・パターソン（暗号学者）は仮説を肯定も否定もしていない | 情報ではあるが、沈黙自体は事後確率をどちらにも動かさない |
...
タイミングの符合がこの仮説の唯一の識別論点であるため —— §2.2 と §2.3 はいずれもその反論において「上位サイファーパンクという大きな集団に当てはまる」に帰着する —— 仮説全体は一つの問いに集約される：2011 年 4 月 26 日は本当にサトシの終わりだったのか。もし原著者がサッサマンの 2011 年 7 月の死より後に活動していたなら、2011 年に死んだ人物は除外され、仮説は他の論点では絞り込めない未分化の候補集合へ崩れ落ちる。
...
残るのは宙吊りの問いである。2014 年の事象は、サトシがサッサマンより長く生きたことを確証もしなければ、2011 年 4 月が終わりだったと立証もしない —— そして仮説全体がこの一つの日付に立つ以上、反証が言える最も強いことは、仮説が依拠するただ一つの事実が記録からは確定できない、ということだ。
...
正体に関する彼女の沈黙は情報である。仮説が真であると知っていれば、彼女の行動の最も自然な読み方は「確認しないことを選んだ」となる。仮説が偽であると知っていれば、「否定しないことを選んだ」となる。沈黙は証拠ではなく、データである。それ自体では事後確率を上下どちらの方向にも動かさない。
