...
The transaction is the object every other design page touches. It is block contents in [the block-chain design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-block-chain-design/), the consumer of signatures and hashes in [the cryptography design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-cryptography-design/), the coinbase and fee mechanism in [the monetary design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-monetary-design/), the propagation payload in [the P2P network design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-p2p-network-design/), the UTXO-set update unit in [the storage design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-storage-design/), the constructed and signed object in [the wallet design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-wallet-design/), and the unit the fee market and the Lightning Network operate on in [the ecosystem design](/BitcoinArchive/entries/design/2009-01-03-bitcoin-ecosystem-design/).