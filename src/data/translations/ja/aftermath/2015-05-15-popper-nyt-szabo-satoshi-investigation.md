...
- **Bit Gold の概念的近接。** サボの Bit Gold 提案 — 計算的プルーフオブワークによる成果物の連鎖を、ビザンチン耐性のあるサーバー網で認証する設計 — は、公表されたあらゆる先行構想の中で、ビットコインのアーキテクチャ的問題空間を最も近く先取りしていた。ポパーは Bit Gold を「ビットコインに最も近い前駆」 と表現した。
