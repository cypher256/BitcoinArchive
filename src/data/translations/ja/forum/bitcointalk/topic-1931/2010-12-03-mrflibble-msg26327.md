...
*こちらの*約24時間のダウンロードは、PATAアダプター経由の（安物の）Compact Flashへ、約4 Mbit/sのADSL回線、ルーターからのport 8333フォワーディング、Debian Lenny上の700MHz Pentium3と256MiB RAMという環境だった。ダウンロード速度はかなり激しく上下した。
