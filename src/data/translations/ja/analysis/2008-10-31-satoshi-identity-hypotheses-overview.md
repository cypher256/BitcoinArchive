...
本同定仮説総覧は[ウェイ・ダイ同定仮説](/BitcoinArchive/ja/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/)にとっての上流の枠付けである。ウェイ・ダイ仮説は本総覧を複数の節で参照する ― §2.1 の候補グルーピング、 §2.4 の方法論的権威、 §4 の比較の基準点 ― 総覧の Group A 分類と「必要だが十分でない」評価枠組みを、自らの論証が立脚する土台として用いる。
