...
sourceNote: "The whitepaper is cited here only for Solana's own claims about how its consensus mechanism works. The issuance schedule, validator economics, initial allocation, the undisclosed loan, and the SEC matter are each cited to their own sources under secondarySources."
