...
あらゆるサトシ正体仮説は、独立した 6 層の非特定化を同時に整合させなければならない —— 日本人風の仮名、タイムゾーンを跨ぐ投稿パターン、英国式英語の書き言葉、匿名リレーメール基盤（AnonymousSpeech.com、vistomail.com）、数年間の通信で一度も IP が漏れない事実、段階的（突発的でない）撤退。本エントリは「サトシ・ナカモト」という仮名が、開発期間（2007 年中頃〜2008 年 8 月）・公の活動期間（2008 年 10 月〜2010 年 12 月）・撤退期間（2010 年 9 月〜2011 年 4 月）を通じて身元を特定されないでいる手段を、公開記録から観察可能な痕跡として 6 層に組織化する。
...
西洋的な人名でも、明らかに技術的なハンドルでも、明示的な匿名エイリアスでもなく、日本人の形をした仮名が選ばれた。この選択は、1990 年代後半から 2000 年代初頭にかけての英語圏の SF とハッカー文化のなかですでに強く形成されていた象徴空間 — ネットワーク化された匿名性が東アジア (とりわけ日本) の視覚的・命名的な記号で語られていた空間 — の内側に位置する。詳細な構造的観察は[テクノオリエンタリズム的読解](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-name-techno-orientalism/)に譲る。
...
BitcoinTalk フォーラムの投稿時間は 24 時間に分散しており、UTC 6:00〜12:00 の時間帯にはサトシの投稿活動がほぼ完全に途絶えるという 1 つの一貫した空白を示す。このパターンは BitcoinTalk 公開アーカイブの 575 投稿から導出できる。サトシのソースコードコミット (v0.1.0〜v0.3.19) のタイムスタンプ分析でも同じ時間帯の空白が観察されており、EST (UTC-5) または CST (UTC-6) 在住を示唆する読みが提示されている — その仮定では空白は現地時間でほぼ 01:00〜07:00 (通常の睡眠時間帯) にあたる。GMT (英国) や JST (日本) の仮定では空白の時間帯が不自然に反転する。コミットパターンの導出については[コード分析エントリ](/BitcoinArchive/ja/entries/analysis/2009-01-09-satoshi-code-analysis/)を参照。
...
本エントリで展開した構造的匿名性の読みは、 [サトシの非技術的スルー](/BitcoinArchive/ja/entries/analysis/2010-12-27-satoshi-non-technical-silence/)における行動的匿名性の読みと補完関係にある ― クリスマス挨拶、同情の表明、個人的な質問といった非技術的な会話の開きにサトシがどう応答したか、一方で技術的やりとりには開いたままであった点。同一の記録済みパターンを別軸から見た独立分析である。

本六層匿名アーキテクチャは[サイファーパンク独立到達分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-cypherpunk-independent-arrival/)によって中核的な参照点として扱われている。同分析は本アーキテクチャを独立到達読解の構造的対応物として用いる ― 「サトシは誰か」という問いを「サトシがサイファーパンク経路にどう関わったか」という問いから切り離し、両側が相互に補強し合う構造として読むのである。

*[補足：本分析が扱う六層の匿名構造は、小説『[ジェネシス ― 創設者の消失と約束](/BitcoinArchive/ja/novel/)』における主人公の沈黙の読解の構造的根拠となる ― 国籍、年齢、声、顔の意図的な非開示は、小説が中心的な解釈枠組みとして扱う対象。]*
