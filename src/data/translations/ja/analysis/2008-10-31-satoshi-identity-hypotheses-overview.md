...
サトシの正体をめぐる議論は、名前が増えるほど難しくなる。デジタルキャッシュの系譜、コード、英語の文体、人生上の出来事との時期のどれかに合う候補でも、サトシとの直接通信によって反証されることがある。このページでは、性質の違う記録を一つの点数に潰さずに並べ、各候補がどこまで持ちこたえ、どこで公的記録に崩されるかを追う。
...
この比較から確定できるのは、12 人の中の勝者ではない。あるレイヤでは説得力を持つ候補が、同じ公的記録によって別のレイヤで崩れるということだ。正体の問いは未解決のままだが、検証の形は見えている。新しい同定を名乗る主張も、4 つのレイヤと単独人物以外の可能性を含む記録に耐えなければならない。
