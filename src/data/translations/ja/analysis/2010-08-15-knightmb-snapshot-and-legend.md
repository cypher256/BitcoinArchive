...
この同定は二次ニュース集約サイト、少なくとも一本の[学術論文](https://arxiv.org/abs/2206.02871)、AI 生成の伝記的プロフィール群によって取り上げられてきた。だが、それらの情報源のいずれも、検証してみると、推論上のギャップを閉じる一次文書——裁判記録あるいは一人称の証言——にまでは遡らない。
