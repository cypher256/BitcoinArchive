...
description: "サトシ・ナカモトが暗号学メーリングリストでビットコインを初めて公表。信頼できる第三者を必要としない、完全な P2P 電子キャッシュシステムを紹介した。"
isSatoshi: true
tags:
  - "announcement"
  - "whitepaper"
...
*[補足：2008 年 10 月 31 日のこの論文の暗号学メーリングリストへの投稿は、小説『[ジェネシス ― 創設者の消失と約束](/BitcoinArchive/ja/novel/)』の発端の場面として描かれている。作中では、リーマンショックの最中に主人公が九ページの論文を暗号学メーリングリストへ投げ込む。]*
