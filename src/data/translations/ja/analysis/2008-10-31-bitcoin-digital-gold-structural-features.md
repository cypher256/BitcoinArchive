...
ホワイトペーパーが掲げたのは電子キャッシュであり、サトシは後に、通信チャネルを通じて運べる金のように希少なものを思考実験に使った。では、ここで効いているのは金の比喩なのか、固定された供給なのか、それとも設計を誰が変えられて誰が変えられないかという制度の形なのか。このページでは、公正な配分、上限、創設者の撤退、プロトコル権限の所在を追っていく。
...
- **もっとも大きな累積プルーフ・オブ・ワークを持つ。** 最多ワークチェーン規則が実際に選ぶのはこれであり、16 年分の難易度を上回ってマイニングしない限り、いかなるフォークもこれを飛び越せない。
...
構造的な特徴を編集的に読む。価格予測や投資論ではない。いくつか留意点がある:
...
上の六つの特徴を 12 チェーンに一度に当てはめたものは、[アルトコインの数と設計の比較](/BitcoinArchive/ja/entries/analysis/2026-07-26-altcoin-count-and-design-comparison/)にある。

個別に問われた 5 つの AI システムは、一つだけ選べと言われて全システムがビットコインに収束した。検証に耐えた主張は、この六特徴のような構造的な主張であり、最上級表現ではなかった。実験の全記録は AI 投資調査にある。

<!-- entry-closing -->

六つの特徴を重ねると、「デジタルゴールド」が希少性だけを指す言葉ではないことが見えてくる。上限、公正な配分、創設者の撤退、ネットワークの蓄積が互いを補強し、後発のチェーンが個々の機能で上回っても、その位置をそのまま引き継げない構造を作っている。これはかなり強い組み合わせだ。けれど、強さは永続の保証ではない。人や組織が変わり続けるなかで、権威を固定しない貨幣基盤が同じ約束を保てるかどうかは、これから積み重なる記録にかかっている。
