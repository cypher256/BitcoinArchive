...
ダニエル・ラリマー（1980年生まれ、BitcoinTalk 上のハンドル名は **bytemaster**）はアメリカのソフトウェア開発者で、後に 3 つの主要なブロックチェーンプロジェクトを創業した。それらの設計思想の中核は、2010年のビットコインフォーラムでの発言にすでに表れていた。すなわち、オンチェーン決済だけでは現実世界の決済に必要なスループットとレイテンシを満たせない、という主張である。

### 初期のビットコイン投稿（2010年）
ラリマーは BitcoinTalk に [2010年7月28日](/BitcoinArchive/ja/entries/forum/bitcointalk/topic-532/2010-07-28-bytemaster-msg6269/)、次のような投稿で初めて登場する。
