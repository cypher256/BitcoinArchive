...
**仮説。** サッサマンの 2011 年 7 月 3 日の自殺 — サトシの最後の文書化されたメールから 3 か月後 — に、サイファーパンク経歴、敵対環境暗号システムの能力、妻メレディス・パターソン（暗号学者・計算機セキュリティ研究者）が正体問題への沈黙を通していること、これらが組み合わさって、本仮説は英語圏議論で繰り返し取り上げられる仮説となった。最も目立つ近年の定式化はエヴァン・ハッチの 2021 年の記事。
