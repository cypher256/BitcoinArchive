...
This Lopp analysis is treated as load-bearing counter-evidence by [the Hal Finney identity hypothesis](/BitcoinArchive/entries/analysis/2014-03-25-hal-finney-satoshi-identity-hypothesis/), which uses Lopp's reconstruction of Patoshi as ~22,503 blocks / ~1.1M BTC with deliberate hashrate suppression as §2.3 "Patoshi mining-scale inconsistency" evidence against the Hal=Satoshi hypothesis.
