...
sourceNote: "The FSA's own guidance page documents the April 1, 2017 entry into force and the registration requirement it created. Mt. Gox's 2014 collapse and the Diet's 2014 finding that Bitcoin is not currency are documented in the secondary sources below."
...
secondarySources:
  - name: "Bankruptcy trustee's Article 157 report to the Tokyo District Court (Nobuaki Kobayashi)"
    url: "https://www.mtgox.com/img/pdf/20140723_report_ja.pdf"
    note: "Covers Mt. Gox's February 28, 2014 civil rehabilitation filing, the April 24, 2014 bankruptcy order, and the trustee's securing of 202,106.000721 BTC."
  - name: "House of Councillors — answer to written question no. 28, 186th Diet session"
    url: "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/186/touh/t186028.htm"
    note: "The Cabinet's March 7, 2014 written answer holding that Bitcoin is not currency under existing Japanese law."
  - name: "Japanese Wikipedia — Payment Services Act (資金決済に関する法律)"
    ...
    note: "Documents the May 25, 2016 Diet passage and June 3, 2016 promulgation of the amendment as Act No. 62 of 2016."
  - name: "Fortune (Reuters) — Japan's Coincheck Says It Lost $400 Million In Cryptocurrency Heist"
    url: "https://fortune.com/2018/01/29/japan-coincheck-cryptocurrency-hack"
    note: "The January 26, 2018 Coincheck hack and the FSA's report-and-remediation order."
  - name: "K&L Gates — Japan's 2019 Amendments to the Payment Services Act and Financial Instruments and Exchange Act"
    ...
    note: "The 2019 rename of 'virtual currency' to 'cryptoasset,' passed by the Diet May 31, 2019."
  - name: "CryptoSlate — Japan's 2022 Payment Services Act stablecoin amendments"
  ...
  - name: "BanklessTimes — Japan Cabinet backs bill to treat cryptocurrencies as financial instruments"
    ...
    note: "The April 10, 2026 Cabinet decision moving cryptoasset regulation from the Payment Services Act into the Financial Instruments and Exchange Act."
relatedEntries:
...
![Editorial infographic on a dark navy background: a courthouse-column icon linked by a dotted line to a cracked, open vault, a small Diet-building silhouette beside a document stamped with a red seal, and a four-point ascending timeline of dated markers along the bottom.](/BitcoinArchive/images/analysis/2017-04-01-japan-payment-services-act-amendment-hero.png)
...
```mermaid
timeline
    2014 : Mt. Gox files for civil rehabilitation (Feb 28)
    %% link: /BitcoinArchive/entries/aftermath/2014-02-28-mt-gox-bankruptcy/
         : Cabinet tells the Diet Bitcoin is not currency (Mar 7)
         : Tokyo court opens bankruptcy proceedings, appoints trustee (Apr 24)
         : Trustee reports 202,106 BTC secured (Jul 23)
    2016 : Diet passes the Payment Services Act amendment (May 25)
    2017 : Amended law takes effect, exchange registration required (Apr 1)
```
