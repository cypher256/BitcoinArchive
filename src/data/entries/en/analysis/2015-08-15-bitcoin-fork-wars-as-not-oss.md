...
inlineLinkKeywords:
  - "the three layers that bind"
translationStatus: complete
---

![A dark diagram titled "The Fork Wars" showing an empty doorway labeled "Authority Vacuum" at the top, connected downward to a stacked block labeled Protocol, Software, and Network/Currency with jagged crack lines running through it, from which four colored curved paths branch outward to circular badges labeled XT, Classic, SegWit2X, and Bitcoin Cash, with a small separate diagram in the corner showing a simple unbroken "ordinary open-source fork."](/BitcoinArchive/images/analysis/2015-08-15-bitcoin-fork-wars-as-not-oss-hero.png)

Bitcoin's 2015-2017 fork wars produced four hard-fork attempts on the main chain (Bitcoin XT, Bitcoin Classic, Bitcoin Unlimited, SegWit2x) and one chain split that survived ([Bitcoin Cash](/BitcoinArchive/entries/currency/2026-07-27-bitcoin-cash-currency-overview/), August 1, 2017). Two adjacent analyses cover what those events were and what naming did to them: [the fork and altcoin genealogy](/BitcoinArchive/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/) records the event sequence, and [the Bitcoin Core rebrand authority-effects analysis](/BitcoinArchive/entries/analysis/2014-03-19-bitcoin-core-rebrand-authority-effects/) reads the lexical asymmetry the 2014 rename introduced. A third question sits underneath both: why did each of these events run as a political and economic contest rather than as an ordinary open-source disagreement?

The reading offered here is structural. Three conditions present in 2014-2017 Bitcoin — a vacuum of designated authority, the economic weight that had accumulated on rule decisions, and a three-layer separation between the protocol, the software, and the live currency network — together made it structurally impossible for a disagreement on a load-bearing parameter to remain a software question. The naming asymmetry covered in the rebrand analysis is the lexical instrument by which these conditions expressed themselves.
...
gantt
    ...
    Wladimir van der Laan takes maintainership :milestone, 2014-04-08, 0d
    %% link: /BitcoinArchive/participants/wladimir-van-der-laan/
    ...
    Bitcoin Unlimited :2016-10-13, 540d
    %% link: /BitcoinArchive/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/
