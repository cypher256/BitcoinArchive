...
New to these concepts? [What owning a bitcoin actually means](/BitcoinArchive/entries/analysis/2026-09-06-what-owning-a-bitcoin-actually-means/) introduces keys, signatures, and receipts with no prior knowledge assumed; this page is the design-document treatment of the same cryptographic primitives.
