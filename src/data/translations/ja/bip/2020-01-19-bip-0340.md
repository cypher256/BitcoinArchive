...
participants:
  ...
  - name: "Tim Ruffing"
    slug: "tim-ruffing"
description: "ビットコインにシュノアデジタル署名を導入、TaprootではECDSAを置換。証明可能安全・非展性・効率的マルチシグ集約により、複雑スクリプトを単純支払いと区別不能に。"
isSatoshi: false
tags:
  - "bip"
  - "schnorr"
...
*[編者注：本 BIP は技術仕様であり、本文は GitHub の bitcoin/bips リポジトリ の MediaWiki 原文から取り込んでいる。見出しは日本語化したが、仕様本体の数式・コード・テストベクトルは原文のまま保持する。文中の英文プローズの逐語訳は将来の 改訂で順次補う。原文: https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki ]*
