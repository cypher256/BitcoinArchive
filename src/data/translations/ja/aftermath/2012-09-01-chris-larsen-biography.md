...
この比較はその条件のもとでは正確だが、別の条件については何も語っていない。XRP レジャーの検証者リストはハッシュパワーをめぐる公開競争ではなく、名指しされた二つの組織による推奨リストである。これはラーセンが提起したエネルギーの問いと表裏をなす取引であり、詳しくは[通貨ページ](/BitcoinArchive/ja/entries/currency/2026-07-27-xrp-currency-overview/)で扱う。
