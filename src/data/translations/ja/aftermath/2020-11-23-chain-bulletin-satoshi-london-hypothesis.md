...
カライヴァノフは後に同じ手法を別の謎にも応用した。[CoinDesk が報じた未公開のサトシ・フィニー間メール](/BitcoinArchive/ja/entries/aftermath/2020-11-26-coindesk-unpublished-satoshi-finney-emails/)では、サトシのメールに現れた UTC+8 というヘッダーはサトシ本人の所在地ではなく送信メールサーバー側の設定によるものだと指摘している。
