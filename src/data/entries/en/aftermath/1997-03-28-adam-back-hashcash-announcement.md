...
Bitcoin's later component synthesis — the longest-chain consensus rule, UTXO model, mining-reward issuance, 21-million cap, and difficulty-adjustment algorithm — is examined in [Bitcoin design lineage](/BitcoinArchive/entries/analysis/2008-10-31-bitcoin-design-lineage/). For a plain-language walkthrough of how this same proof-of-work idea becomes Bitcoin's mining race, see [what miners are actually racing to do](/BitcoinArchive/entries/analysis/2026-09-06-what-miners-are-actually-racing-to-do/).
