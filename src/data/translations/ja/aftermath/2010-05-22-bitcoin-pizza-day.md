---
title: "ビットコインピザデー — ラズロ・ハニエツが 10,000 BTC でピザ 2枚を購入"
...
tags:
  ...
  - "bitcointalk"
secondarySources:
  - name: "Laszlo Hanyecz — Bitcoin Wiki"
    url: "https://en.bitcoin.it/wiki/Laszlo_Hanyecz"
  - name: "Bitcoin Pizza Index"
    url: "https://bitcoinpizzaindex.net/"
...
ビットコインによる最初の既知の物理商品購入は、ありふれた申し出から始まった。ピザ 2 枚、翌日に残す分、そしてコインでの支払い。2010年5月18日、[ラズロ・ハニエツ](/BitcoinArchive/ja/participants/laszlo-hanyecz/)は BitcoinTalk フォーラムにこう投稿した：

<!-- quote: q1 -->
<!-- speaker: Laszlo Hanyecz -->
> 「ピザ 2枚と引き換えに 10,000 ビットコイン支払うよ。ラージサイズ 2枚くらいで、次の日に残りを食べられるようにしたいんだよね。残りをちょっとずつ食べるのが好きなんだよ。」
...
当時の 10,000 BTC は約 41 ドルだった。これはビットコインによる最初の物理的商品の購入として知られている。それ以前のビットコイン取引はデジタルのみだった。為替レート計算や P2P 送金にとどまっており、たとえば[マルッティ・マルミが 2009年10月に 5,050 BTC を 5.02 ドルで売却した、ビットコイン初の法定通貨交換](/BitcoinArchive/ja/entries/aftermath/2009-10-12-martti-malmi-first-btc-sale/)もその一例である。ピザ取引は、ビットコインが実世界の交換媒体として機能できることを証明した。
...
<!-- audit:quote-skip -->
> 「いや、後悔はしてないよ。あんなふうにビットコインの初期の歴史に関われたのは、すごいことだったと思うんだ。みんなあのピザのことを知っているし、面白い話だよね。誰もがどこか自分のことのように感じられるからさ……」

5月22日は現在、世界中のビットコインコミュニティで毎年「ビットコインピザデー」として祝われている。

2025年の 10 万ドル超の価格では、10,000 ビットコインは 10 億ドル以上の価値がある。史上最も高額なピザと呼ばれている。

このピザの日の出来事は[ラズロ・ハニエツ伝記](/BitcoinArchive/ja/participants/laszlo-hanyecz/)に深く根ざしており、冒頭の語りではその人物像を決定づける出来事として、専用の「ビットコイン・ピザの日」節では現実世界における最初の既知の商業ビットコイン取引として登場する。伝記は 5 月 22 日の取引に参加者年表と意義節を通じて繰り返し戻ってくる。

*[補足：ラズロ・ハニエツのピザ取引は、小説『[ジェネシス ― 創設者の消失と約束](/BitcoinArchive/ja/novel/)』で名指しで言及される、ビットコインが初めて現実世界と接触した初期の出来事の一つとして扱われる。]*

<!-- entry-closing -->

この取引の歴史的な重みは、後年のドル換算額から生まれたものではない。プロトコル上の価値が画面の外へ出て、食べ物を買い、普通の家庭の取引に入ったことにある。価格比較が物語の一番大きな声になったとしても、記録そのものが示すのは、ビットコインが現実世界へ踏み出したことだ。
