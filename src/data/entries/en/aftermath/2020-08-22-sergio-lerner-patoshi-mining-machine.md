...
description: "Lerner published The Patoshi Mining Machine, using re-mining simulation to prove Satoshi mined on a single high-end CPU with 5 parallel threads — refuting the Whale Alert claim."
isSatoshi: false
tags:
  - "patoshi"
  - "mining"
