...
| [Paul Le Roux](/BitcoinArchive/participants/paul-le-roux/) | 🟡 Surface alignment — Windows + C++ + cryptographic shipping, but the public shipping record stops in 1999 | Windows NT / 9x | C++ | **E4M** (Windows-only disk encryption, first released December 1998; later built into TrueCrypt) |
