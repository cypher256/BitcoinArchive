...
自己発言インベントリが捉えるのは *内容軸* ― サトシが何を語ったか。 補完軸 ― サトシが何に*応じなかったか* ― は[サトシの非技術的スルー](/BitcoinArchive/ja/entries/analysis/2010-12-27-satoshi-non-technical-silence/)で扱う。 非技術的な会話の開きが返信なしか、 一行の挨拶か、 技術的内容への切り返しを受けたかを目録化したエントリー。
