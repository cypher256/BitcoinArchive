...
Séchet's record matters in this archive primarily as the technical lead of the 2017 BCH hard fork — the only Bitcoin protocol fork that produced a chain with substantive surviving network share. The replay-protection and difficulty-adjustment mechanisms he designed are what allowed BCH to launch viably at all, and they have since been studied and adapted in other contentious-fork events. The 2018 BSV hash war and the 2020 BCHA / eCash split are downstream events in the same lineage and are documented in the related entries linked above. The phase-by-phase chronology of the 2015–2017 dispute that culminated in the BCH fork — including the role of the Bitcoin ABC implementation Séchet led — is collated in [the block-size war overview](/BitcoinArchive/entries/analysis/2015-08-15-block-size-war-2015-2017-overview/).

This biography is invoked by [the block-size war 2015–2017 overview](/BitcoinArchive/entries/analysis/2015-08-15-block-size-war-2015-2017-overview/) as the technical-lead anchor of the Bitcoin Cash hard-fork phase that the overview's phased reconstruction culminates in.
