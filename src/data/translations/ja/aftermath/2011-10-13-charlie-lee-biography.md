...
実際の変更は四点に絞られている。Scrypt によるプルーフ・オブ・ワーク、2.5 分のブロック間隔、8,400 万枚の上限、840,000 ブロックごとの半減。いずれもビットコインの数値をちょうど 4 倍または 4 分の 1 にした値で、[ローンチ記録](/BitcoinArchive/ja/entries/aftermath/2011-10-13-litecoin-launch/)が扱うとおり内部的に整合している。
