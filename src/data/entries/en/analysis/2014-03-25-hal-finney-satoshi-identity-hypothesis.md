...
isSatoshi: false
description: "He built RPOW, received the first Bitcoin transaction, and lived blocks from Dorian Satoshi Nakamoto. The evidence for Hal Finney as Satoshi, weighed."
tags:
  - "satoshi-identity"
  - "hal-finney"
  - "cypherpunk"
...
![Diagram titled "The Empty Center" showing an empty silhouette profile surrounded by evidence icons (a server, a fingerprint, a magnifying-glass loop, a checklist) with dashed lines converging on it, next to two parallel timeline bars for the April 2009 and August 2010 alibi windows and two faceless silhouette figures — one running, one seated — on the right.](/BitcoinArchive/images/analysis/2014-03-25-hal-finney-satoshi-identity-hypothesis-hero.png)

Hal Finney lived a few blocks from a Japanese-American engineer named Dorian Satoshi Nakamoto. He was a Caltech-trained cryptographer who built [RPOW (Reusable Proof-of-Work, 2004)](/BitcoinArchive/entries/aftermath/2019-08-21-hal-finney-rpow-recognition/), the first known person other than Satoshi to run Bitcoin, the recipient of the first person-to-person Bitcoin transaction (10 BTC, January 12, 2009). The geographic and biographical convergence is the load-bearing piece of the [Hal Finney](/BitcoinArchive/participants/hal-finney/) = Satoshi claim, articulated most prominently in Andy Greenberg's [March 25, 2014 Forbes feature *"Nakamoto's Neighbor"*](/BitcoinArchive/entries/aftermath/2014-03-25-greenberg-forbes-nakamotos-neighbor/).

The claim surfaced again in Florian Cafiero's 2026 stylometric analysis commissioned for the New York Times Adam-Back investigation, in which Finney was reported as nearly tied with Back for closest match. Six weeks later the April 2026 [Finding Satoshi documentary](/BitcoinArchive/entries/aftermath/2026-04-22-finding-satoshi-finney-sassaman-documentary/) proposed a multi-person reading naming Hal Finney and Len Sassaman as co-creators of Bitcoin (the documentary's claims and Adam Back's counter-evidence are treated at the linked entry).

## 1. The evidence

Finney is the person behind the Satoshi Nakamoto pseudonym. His documented public-record interactions with "Satoshi" — the [January 2009 email exchange](/BitcoinArchive/entries/aftermath/2009-01-08-satoshi-to-finney-release/), the [first Bitcoin transaction](/BitcoinArchive/entries/aftermath/2009-01-12-first-bitcoin-transaction/) on January 12, 2009, and the 2013 [*Bitcoin and Me*](/BitcoinArchive/entries/aftermath/2013-03-19-bitcoin-and-me-hal-finney/) retrospective — were stagecraft to maintain the pseudonym. He operated as Satoshi from the development phase (2007–2008) until at least his August 2009 ALS diagnosis, and possibly until his early-2011 retirement.
...
### 1.5 Cypherpunk credentials, capability, and English level
...
Two events are alibi-class: the April 18, 2009 race-day window and the August 14–15, 2010 Singularity Summit window. Their position relative to Satoshi's documented activity:
...
### 2.1 The April 18, 2009 race-day alibi
...
The alibi requires that Finney's race photographs and timing-chip data were genuine (not fabricated by Fran in 2014), and that the email and on-chain transaction timestamps are accurate (not subject to clock drift or manipulation). Both are routinely the case, and the on-chain record (block 11,408 timestamp) is independent of any private record Fran could have manipulated. Greenberg's 2014 Forbes piece predates Lopp's 2023 formalization by nearly a decade and was the first published account of the photographic record: Greenberg reported being shown the race photographs by Fran in person during his visit. This is not an alibi constructed retrospectively for the purpose of denying the hypothesis; it is a contemporaneously documented activity that happened to coincide with Satoshi-network activity.

Lopp's 2023 analysis and Peter Miller's 2026 follow-up add four further structural observations against the hypothesis:

- **IP address divergence.** The January 10, 2009 Bitcoin debug log records Finney's IRC node at IP `207.71.226.132`, while Satoshi's IP appears as `68.164.57.219`: different ISPs, different geographic regions. If Finney were Satoshi, the two endpoints would not appear simultaneously as distinct peers in the same debug log. The same week's network environment is examined from a different angle in [Satoshi's launch-environment analysis](/BitcoinArchive/entries/analysis/2009-01-10-satoshi-launch-environment/): activity cadence and the "from where I am" phrasing in Satoshi's email to Finney.
...
### 2.2 Finney's 2013 *Bitcoin and Me* first-person framing of Satoshi
...
### 2.3 The Patoshi mining-scale inconsistency
...
### 2.5 ALS progression and the August 2010 Singularity Summit
