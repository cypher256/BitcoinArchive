...
participants:
  - name: "riX"
    slug: "rix"
description: "BitcoinTalk トピック 25 における riX の文脈投稿。msg173 の前。"
isSatoshi: false
tags: []
...
<!-- quote: q1 -->
<!-- tone-skip -->
> 現在、bitcoin を送ってくれた顧客にはメールメッセージを要求している。これは理想的ではない。なぜなら、別の人がそのトランザクションを知っていた場合、bitcoin を送った本人よりも先にメッセージを送ることで、そのトランザクションの手柄を横取りできるからだ。
<!-- /tone-skip -->
