---
title: "BIP 340 — secp256k1のためのSchnorr署名"
date: 2020-01-19
source: bip
...
participants:
  ...
  - name: "Tim Ruffing"
    slug: "tim-ruffing"
description: "ビットコインにSchnorrデジタル署名を導入し、Taprootトランザクションでは従来のECDSAを置き換えた。Schnorr署名は証明可能な安全性を持ち、展性がなく、効率的なマルチシグ集約を可能にし、複雑なスクリプトをオンチェーンで単純な支払いと区別不能にする。"
isSatoshi: false
tags:
  - "bip"
  - "schnorr"
