...
2010年2月5日、NewLibertyStandardがBitcoinTalkフォーラムでこう提案した。
...
*[「BTC」と฿記号は今日でも世界中で使われている。通貨コード「XBT」がISO 4217準拠の代替として後に提案された（「BT」はブータンの国コードであるため）が、「BTC」の方がはるかに広く認知されている。]*
