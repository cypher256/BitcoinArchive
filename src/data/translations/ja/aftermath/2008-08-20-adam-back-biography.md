...
```mermaid
timeline
    title アダム・バックのビットコイン関連年表
    1997-03 : Hashcash をサイファーパンク・メーリングリストで発表
    1998-12 : サイファーパンク・メーリングリストで b-money 批判 - 貨幣設計上の 7 つの論点を提示
    2002-08 : Hashcash 論文の改訂版 - コストトークンを「mint」 として位置付け
    2008-08 : サトシからの最初の既知メール (8月20日) - 最初期のビットコイン接触
            : サトシをウェイ・ダイの b-money に紹介；サトシがウェイ・ダイにメール (8月22日)
    2014 : Blockstream を共同設立、CEO 就任
    2024-02 : COPA v ライト裁判で宣誓証言
    2026-04 : NYT／カレイロウによってサトシ最有力候補と名指される；自己否定
```
