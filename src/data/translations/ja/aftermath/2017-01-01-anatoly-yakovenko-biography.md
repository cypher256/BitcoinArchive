...
このアーカイブが名前を与えているのは最後の行だ。分断されたときのビットコインの保守性を、欠点ではなく性質として扱うのが[デジタルゴールドの構造的特徴](/BitcoinArchive/ja/entries/analysis/2008-10-31-bitcoin-digital-gold-structural-features/)の見方である。
