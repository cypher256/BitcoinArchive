...
後発の暗号資産 (イーサリアム、[リップル](/BitcoinArchive/ja/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/)、カルダノ、ソラナ) は、より高機能な仮想マシン、より速い承認、より低い手数料、より豊富なプログラマビリティを備える。2009 年以降の継続稼働年数を除けば、どの単一の技術軸でもビットコインはもはや最前線ではない。それにもかかわらず市場は一貫して、ビットコインを金に最も近い資産 — 長期保有の価値保存手段、準備資産、相手方のロードマップに依存しない保有 — として価格付けする。
