...
ラーナーは、「Pattern」と「Satoshi」を組み合わせた造語である **「Patoshi」** を、[2013年から研究してきた](/BitcoinArchive/ja/entries/aftermath/2013-04-17-sergio-lerner-patoshi-analysis/)特徴的なマイニング指紋を指す語として用いた。この名称は、その後のサトシのマイニング行動に関するすべての学術的・コミュニティ議論における標準的な呼称となった。
