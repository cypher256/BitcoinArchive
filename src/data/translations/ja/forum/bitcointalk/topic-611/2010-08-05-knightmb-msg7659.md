...
participants:
  - name: "knightmb"
    slug: "knightmb"
description: "BitcoinTalk トピック 611 における knightmb の文脈投稿。サトシを引用."
isSatoshi: false
tags: []
quotes:
  - id: "q1"
...
これら*すべての*関数呼び出しに対する俺の唯一の不満は、IP to IP の直接支払いがまったく表示されないことだ。現状では、IP to IP で支払いを送っても、これらのコマンドでは見つけられない。残高が正しいことは分かるが、それがどこから来たものかは分からない。どちらのコマンドもそのトランザクションについての情報を表示してくれないからだ。
