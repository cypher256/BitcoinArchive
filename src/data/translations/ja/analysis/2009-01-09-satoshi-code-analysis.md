...
- **タイムゾーン:** 06:00〜12:00 UTC にコミットがほぼ皆無であることから、EST（UTC-5）または CST（UTC-6）在住の可能性が最も高い。この帯域は [Chain Bulletin のフォーラム・メーリングリストのタイムスタンプによる GMT 読解](/BitcoinArchive/ja/entries/aftermath/2020-11-23-chain-bulletin-satoshi-london-hypothesis/)とは重ならない。両読解が確定すること・確定しないことは[国籍の分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-nationality-question/)で併せて読む
