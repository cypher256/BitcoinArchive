---
title: "What they said about Satoshi — from first doubts to a Nobel nomination"
...
participants:
  ...
  - name: "Jeff Garzik"
    slug: "jeff-garzik"
description: "Doubters called it unscalable in 2008. A famed hacker failed to break the code. A judge, a dictionary, and a Nobel nominator weighed in. What others said about Satoshi, read as one record."
isSatoshi: false
tags:
  - "satoshi-identity"
  - "testimony"
...
secondarySources:
  - name: "The New Yorker — The Crypto-Currency (Joshua Davis, full-text mirror)"
    ...
    note: "Source for Dan Kaminsky's 2011 code-review account and verdict."
  - name: "HuffPost — Bhagwan Chowdhry, on nominating Satoshi for the Nobel Prize in Economics"
    url: "https://www.huffpost.com/entry/i-shall-happily-accept-th_b_8462028"
  - name: "Unenumerated — Nick Szabo, Bitcoin, what took ye so long?"
    url: "http://unenumerated.blogspot.com/2011/05/bitcoin-what-took-ye-so-long.html"
  - name: "Bitcoin Magazine — Vitalik Buterin, Satoshi's Genius"
  ...
  - name: "VICE — the CIA's FOIA response on Satoshi Nakamoto records"
    url: "https://www.vice.com/en/article/who-is-satoshi-nakamoto-cia-foia-fbi/"
  - name: "Cointelegraph — the FBI's 2024 FOIA response on Satoshi Nakamoto records"
    url: "https://cointelegraph.com/news/satoshi-nakamoto-bitcoin-creator-fbi-foia-response"
  - name: "CoinDesk — 'Satoshi' enters the Oxford English Dictionary"
    url: "https://www.coindesk.com/markets/2019/10/15/satoshi-enters-the-oxford-english-dictionary"
  - name: "Euronews — the faceless Satoshi statue unveiled in Budapest"
  ...
  - name: "Reason — the disappearing Satoshi statue in Lugano"
...
![A faintly glowing, faceless human outline at the center, ringed by varied silhouettes — skeptics, a hacker at a terminal, a robed judge, a sculptor — each sending a quotation line toward the empty figure](/BitcoinArchive/images/analysis/2008-08-21-what-they-said-about-satoshi-hero.png)
...
```mermaid
timeline
    title What they said, 2008 - 2024
    2008 : First reply - a pointer to prior art (Aug 21)
    %% link: /BitcoinArchive/entries/correspondence/adam-back/2008-08-21-adam-back-to-satoshi-b-money-pointer/
         : Mailing-list doubts - scale, botnets, inflation (Nov)
    %% link: /BitcoinArchive/entries/emails/cryptography/bitcoin-p2p-e-cash-paper/2008-11-01-re-bitcoin-p2p-e-cash-paper-donald/
         : Finney - a very promising idea (Nov 7)
    %% link: /BitcoinArchive/entries/emails/cryptography/bitcoin-p2p-e-cash-paper/2008-11-07-re-bitcoin-p2p-e-cash-paper-finney/
    2009 : Finney runs the 10 million dollar arithmetic (Jan 10)
    %% link: /BitcoinArchive/entries/emails/cryptography/bitcoin-v0-1-released/2009-01-10-re-bitcoin-v0-1-released-finney/
    2011 : Kaminsky fails to break the code - team or genius (Oct)
    %% link: /BitcoinArchive/entries/aftermath/2011-10-10-dan-kaminsky-bitcoin-security/
    2013 : Lerner finds the Patoshi pattern (Apr)
    %% link: /BitcoinArchive/entries/aftermath/2013-04-17-sergio-lerner-patoshi-analysis/
         : Finney - comfortable with my legacy (Mar)
    %% link: /BitcoinArchive/entries/aftermath/2013-03-19-bitcoin-and-me-hal-finney/
    2014 : Newsweek names the wrong Nakamoto (Mar)
    %% link: /BitcoinArchive/entries/aftermath/2014-03-06-newsweek-dorian-nakamoto/
    2015 : Nobel Prize in Economics nomination
    2019 : satoshi enters the Oxford English Dictionary
    2021 : Budapest unveils a faceless statue (Sep)
    2024 : UK High Court - Wright is not Satoshi (Mar 14)
...
That is where the record of other people's words about Satoshi currently rests. The man [said almost nothing about himself](/BitcoinArchive/entries/analysis/2008-08-20-satoshi-self-statements/) and [answered nothing personal](/BitcoinArchive/entries/analysis/2010-12-27-satoshi-non-technical-silence/); the first responses put doubt in writing, and later retrospectives set admiration and regret beside it; the verifiers found code that defended itself and a fortune that never moved; a court settled who he is not; and the durable public monuments to him are a mirror and an outline — offering no face except the one supplied by whoever happens to be looking.
