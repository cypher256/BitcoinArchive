...
export const tagTranslations: Record<string, string> = {
  ...
  'asic': 'ASIC',
  'block-size': 'ブロックサイズ',
  'block-size-war': 'ブロックサイズ戦争',
  'bip-101': 'BIP 101',
  'bitcoin-cash': 'Bitcoin Cash',
  'bitcoin-sv': 'Bitcoin SV',
  'cancelled-fork': '中止されたフォーク',
  'altcoin': 'アルトコイン',
  'cardano': 'Cardano',
  'memecoin': 'ミームコイン',
  'monero': 'モネロ',
  ...
  'memoir': '回顧録',
  'memorial': '追悼',
  'memory-dealers': 'Memory Dealers',
  'merge-mining': 'マージマイニング',
  'mining': 'マイニング',
  'litecoin': 'Litecoin',
  'dogecoin': 'Dogecoin',
  ...
  'alex-thorn': 'アレックス・ソーン',
  'galaxy-digital': 'Galaxy Digital',
  'lost-property': '遺失物拾得',
  'new-york': 'ニューヨーク',
  'noah-doe': 'ノア・ドゥ',
  'satoshi-coins': 'サトシのコイン',
  'dhs': 'DHS',
  'foia': 'FOIA',
  'james-murphy': 'ジェームズ・マーフィー',
  'litigation': '訴訟',
  'rana-saoud': 'ラナ・サウド',
  'off-by-one': 'オフバイワン',
  'ironkey': 'IronKey',
  'forgotten-password': 'パスワード忘却',
  'lost-keys': '鍵喪失',
  'lost-bitcoin': '失われたビットコイン',
  'iconic-losses': '象徴的損失',
  'irreversibility': '不可逆性',
  'newport-landfill': 'ニューポート埋立地',
  ...
  'design': '設計書',
  'design-lineage': '設計系譜',
  'ideological-lineage': '思想史的系譜',
  'communication-pattern': 'コミュニケーションパターン',
  'studied-silence': '計算された沈黙',
  'information-control': '情報統制',
  'hayek': 'ハイエク',
  'denationalisation-of-money': '貨幣発行自由化論',
  'extropians': 'エクストロピアン',
  'libertarianism': 'リバタリアニズム',
  'design-intent': '設計意図',
  'design-drift': '設計乖離',
  'mining-centralization': 'マイニング集中化',
  'etf': 'ETF',
  'methodology': '方法論',
  'dataset': 'データセット',
  ...
  // Additional translations (2026-07-28): nation-state Bitcoin policy entries
  'el-salvador': 'エルサルバドル',
  'legal-tender': '法定通貨',
  'strategic-bitcoin-reserve': '戦略ビットコイン準備',
  'bitcoin-law': 'ビットコイン法',
  'asset-forfeiture': '資産没収',
  'asset-seizure': '資産押収',
  'chivo-wallet': 'Chivo ウォレット',
  'european-union': 'EU',
  'exchange-registration': '交換業登録',
