...
送金付きメールにはすでに使える。送信ダイアログはサイズ変更可能で、好きなだけ長いメッセージを入力できる。接続するとそのまま直接送信される。受取人はトランザクションをダブルクリックして全文を見ることができる。有名人がメールを読みきれないほど受け取っているが、それでもファンが連絡できる方法を持ちたい場合、ビットコインを設定してウェブサイトにIPアドレスを公開すればよいのだ。「このIPの優先ホットラインにXビットコインを送ってくれれば、メッセージを私が直接読む。」
