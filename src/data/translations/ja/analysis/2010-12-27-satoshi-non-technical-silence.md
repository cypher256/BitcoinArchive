...
ある相手は「ハッピー・クリスマス、サトシ」と挨拶を送り、サトシが世界のどこにいて、そこでクリスマスを祝うのかも分からないと軽く添えた。返ってきたのは SPV の設計論だった。「ありがとう」も「君もね」もない。サトシの通信記録には、この小さなすれ違いが繰り返し現れる。プロトコルのためには開く通信路が、ひとりの人物が見えそうになると閉じる。
...
2009 年 5 月 2 日のマルッティ・マルミとの初接触のやり取りは、ビットコイン・インスティテュートが浮かび上がらせた最も明確な例外である。サトシはマルミに対し、彼のビットコイン理解は「的を射ている」と述べ、 `anti-state.com` フォーラムの反法定通貨の懐疑論者を「ネアンデルタール的」と性格付け、通貨採用について「燃えやすいが火花がない」という比喩を共有する。こうして、個人情報の地盤ではなく **政治・文化的** 地盤に踏み込んでいる。
...
私は、このパターンを、冷たい人物や秘密主義の人物の肖像というより、通信そのものに現れた境界として読む。挨拶、称賛、場所、感情が通信の端まで届くと、返信はプロトコルへ戻るか、そこで止まる。マルミとのまれな例外が、この境界を単純な無愛想さにしない。共有する思想の場では姿を見せながら、個人の記録からは姿を消す人物が、そこにはいる。
