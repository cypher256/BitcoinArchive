...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi reports getting the Linux build to compile, updates the makefile for standard install paths, adds xpm icon files, and documents the build process in build-unix.txt."
isSatoshi: true
tags:
  - "correspondence"
  - "early-contributor"
