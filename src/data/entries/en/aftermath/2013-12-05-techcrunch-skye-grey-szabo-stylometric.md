...
Skye Grey's analysis is manual stylometry: human-judged phrase and pattern matching, not algorithmic statistical fingerprinting. The April 2014 Aston University forensic-linguistic study — which independently ranked Szabo as the closest match among 11 candidates — applied more formal stylometric methods and reached a similar conclusion. The 2026 [John Carreyrou / NYT investigation](/BitcoinArchive/entries/aftermath/2026-04-08-nyt-carreyrou-adam-back-satoshi-investigation/) used algorithmic large-population stylometric comparison against 620 candidates and named [Adam Back](/BitcoinArchive/participants/adam-back/) instead, with Florian Cafiero (the linguist commissioned for the NYT analysis) himself describing the result as inconclusive. Stylometric methodology has, across these three independent investigations, produced two different leading candidates depending on the corpus and method.
