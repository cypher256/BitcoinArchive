...
サトシの正体をめぐる仮説は、6 つの痕跡を同時に説明しなければならない。日本人風の仮名、複数の時間帯にまたがる投稿、英国式の英語、匿名リレーを経由したメール、数年にわたって IP を漏らさなかった通信、そして段階的な撤退。どれか 1 つだけを説明しても、全体には届かない。ここでは、「サトシ・ナカモト」という仮名が、開発期間（2007 年中頃〜2008 年 8 月）・公の活動期間（2008 年 10 月〜2010 年 12 月）・撤退期間（2010 年 9 月〜2011 年 4 月）を通じて身元を特定されなかったのはなぜかを、公開記録から追える 6 層の痕跡に分けて読む。

ここで扱うのは「サトシは誰か」ではなく、「どう匿名であり続けたのか」という問いだ。身元候補の比較は[身元仮説総覧](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/)で、これだけの材料が残っているのになぜ特定できないのかは[識別の非対称性](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identification-asymmetry/)で扱う。
