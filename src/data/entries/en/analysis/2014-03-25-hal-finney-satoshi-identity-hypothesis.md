...
Hal Finney lived a few blocks from a Japanese-American engineer named Dorian Satoshi Nakamoto. He was a Caltech-trained cryptographer who built [RPOW (Reusable Proof-of-Work, 2004)](/BitcoinArchive/entries/aftermath/2019-08-21-hal-finney-rpow-recognition/), the first known person other than Satoshi to run Bitcoin, the recipient of the first person-to-person Bitcoin transaction (10 BTC, January 12, 2009). The geographic and biographical convergence is the load-bearing piece of the [Hal Finney](/BitcoinArchive/participants/hal-finney/) = Satoshi claim, articulated most prominently in Andy Greenberg's [March 25, 2014 Forbes feature *"Nakamoto's Neighbor"*](/BitcoinArchive/entries/aftermath/2014-03-25-greenberg-forbes-nakamotos-neighbor/). The claim surfaced again in Florian Cafiero's 2026 stylometric analysis commissioned for the New York Times Adam-Back investigation, in which Finney was reported as nearly tied with Back for closest match. Six weeks later the April 2026 [Finding Satoshi documentary](/BitcoinArchive/entries/aftermath/2026-04-22-finding-satoshi-finney-sassaman-documentary/) proposed a multi-person reading naming Hal Finney and Len Sassaman as co-creators of Bitcoin (the documentary's claims and Adam Back's counter-evidence are treated at the linked entry).
