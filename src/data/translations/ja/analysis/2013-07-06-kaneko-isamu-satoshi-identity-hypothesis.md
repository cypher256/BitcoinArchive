...
「金子勇＝サトシ」 仮説は、主要なサトシ正体仮説のうち唯一、ほぼ日本語圏内でしか語られていない —— 2ch・5ch フォーラムと日本の技術系メディアでは盛んに議論されるが、英語圏のビットコイン議論にはほとんど浸透していない。仮説の対象、[金子勇](https://ja.wikipedia.org/wiki/%E9%87%91%E5%AD%90%E5%8B%87)（1970–2013）は東京大学の助手で、2002 年 5 月に 2 ちゃんねるで P2P ファイル共有ソフト Winny を公開、2004〜2011 年の 7 年半を著作権法違反幇助の刑事裁判の被告として過ごし、最高裁による無罪確定の 2 年後の 2013 年 7 月に心筋梗塞で死去した —— ツール開発者の刑事責任を巡る判例として日本の技術政策議論で広く参照される事件である。本エントリは[金子勇＝サトシ](/BitcoinArchive/ja/participants/isamu-kaneko/)仮説、日本語圏の支持論者の論じ方、そして反証を同じ詳細度で並べる。判断は読者に委ねる。他の固有名候補仮説との比較は[サトシ正体仮説の概観](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/)を参照。
