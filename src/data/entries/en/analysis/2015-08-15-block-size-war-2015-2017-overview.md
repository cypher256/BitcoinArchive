...
The [New York Agreement (NYA)](https://en.wikipedia.org/wiki/SegWit2x), signed on May 23, 2017 at the Consensus 2017 conference, was the most ambitious compromise attempt of the war. Representatives of 58 major Bitcoin businesses — exchanges, mining pools, payment processors, and Bitcoin-holding companies — committed to bundle two protocol changes:
...
The block-size war is the most-cited single episode in arguments about how Bitcoin protocol changes happen. Where the [Bitcoin family-tree analysis](/BitcoinArchive/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/) catalogues the dispute alongside the broader fork-history record, and [the "fork wars as not OSS" analysis](/BitcoinArchive/entries/analysis/2015-08-15-bitcoin-fork-wars-as-not-oss/) reads it through the lens of open-source governance, this entry collates the documented sequence — the phases, the proposals, the activation outcomes — so that arguments about Bitcoin's governance model can refer back to a shared record of what actually happened.

This phased reconstruction is treated as the canonical record by two of the dispute's primary-record entries. [The August 2015 Bitcoin XT launch entry](/BitcoinArchive/entries/aftermath/2015-08-15-bitcoin-xt-launch/) reads this overview as the broader sequence its inaugural event is part of. [The August 2017 Bitcoin Cash fork entry](/BitcoinArchive/entries/aftermath/2017-08-01-bitcoin-cash-fork/) cites it as the dispute's full phased record from which the August 1 split is the closure event.
