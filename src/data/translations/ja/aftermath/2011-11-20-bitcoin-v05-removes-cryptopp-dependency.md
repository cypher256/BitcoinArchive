...
[ウェイ・ダイ＝サトシ仮説エントリ §1.2](/BitcoinArchive/ja/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/) はコードベース依存を、ウェイ・ダイが直接的なコード貢献の観点で他候補と構造的に区別不能であるとする帰無仮説に対する反証として位置づける。本エントリはその反証の上限を記録する: v0.5.0 で終了する。
