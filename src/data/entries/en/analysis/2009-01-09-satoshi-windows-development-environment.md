...
Later entries use this Windows-only finding in two distinct registers. On the identity side, each of the individual candidate readings — [the Wei Dai identity hypothesis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/), [the Hal Finney identity hypothesis](/BitcoinArchive/entries/analysis/2014-03-25-hal-finney-satoshi-identity-hypothesis/), and [the Peter Todd identity hypothesis](/BitcoinArchive/entries/analysis/2024-10-08-todd-satoshi-identity-hypothesis/) — weighs the candidate's documented working environment against the Windows-only pattern recorded here, and [the identity-hypotheses overview](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/) lifts that test into a constraint on candidate selection across the whole field. On the design side, [the architecture-evolution design entry](/BitcoinArchive/entries/design/2009-01-03-bitcoin-architecture-evolution/) reads the Windows-centric early codebase as the starting point of architectural drift — the technical decisions inherited from Phase 1 that successor maintainers had to live with.
