...
> [Quote from: sirius-m on January 05, 2010, 01:20:06 AM](/BitcoinArchive/ja/entries/forum/bitcointalk/2010-01-05-sirius-msg84/)
> 引用：「しかし、そのトランザクションが完了した後、新しいトランザクションが開始されていません。あるいは開始されているのかもしれません。リストにはトランザクションが1つしかありませんが、「ステータス」のブロック数は131まで増えています。これが正しい動作なのでしょうか？同じトランザクションで処理を続け、120ブロックごとにコインを生成するのですか？それとも新しいトランザクションを開始するはずなのですか？」
