...
This Kaneko hypothesis entry is referenced from [the satoshi-identity-hypotheses overview](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/) as one of the ten candidate hypotheses in its comparison anchor — Kaneko is placed in the overview's Group A taxonomy alongside the other named candidates within the necessary-but-not-sufficient evaluation framework.
