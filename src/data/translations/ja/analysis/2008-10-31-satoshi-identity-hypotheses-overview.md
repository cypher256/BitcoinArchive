...
- 「サトシ・ナカモト」という仮名の日本的な形は、いずれの単独候補とも独立に正体そのものに関わる論点であり、[テクノオリエンタリスト署名分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-name-techno-orientalism/)で扱う。サトシが実際に日本人だったかは、§2.1 の英語水準の次元を単独の論点まで掘り下げ、それに照らして[金子勇](/BitcoinArchive/ja/participants/isamu-kaneko/)の候補性を個別に検証するもので、[国籍の分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-nationality-question/)で扱う。
