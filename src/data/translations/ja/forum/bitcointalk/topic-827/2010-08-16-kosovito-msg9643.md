...
participants:
  - name: "kosovito"
    slug: "kosovito"
description: "BitcoinTalk トピック 827 における kosovito の文脈投稿。msg9590 の後。"
isSatoshi: false
tags: []
...
3) 0.3.10 にアップグレードする。
4) すべてのブロックがダウンロードされる。約 1時間かかる。

上級ユーザー向けに、すべてのブロックをダウンロードする代わりに代替手順 2 を使うこともできる：

2a) knightmb の blk ファイルをダウンロードして、自分の blk0001.dat と blkindex.dat ファイルを置き換える
http://knightmb.dyndns.org/files/bitcoin/blocks/
http://rapidshare.com/files/413168038/BitcoinBlocks.torrent

ブロックをダウンロードした後にブロック 74638 で止まってしまった場合は、これらのパラメーターを追加してみてほしい：
