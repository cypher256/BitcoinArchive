...
participants:
  - name: "Gavin Andresen"
    slug: "gavin-andresen"
description: "BitcoinTalk トピック 611 におけるギャビン・アンドレセンの文脈投稿。msg6706 の後。"
isSatoshi: false
tags: []
quotes:
  - id: "q1"
...
> > 簡単な提案を二つほど。
> >
> > キー名に "class" を使うと、少なくとも JavaScript や、おそらく他の "class" が予約語の言語で問題が起きる。"type" や "variety"、その他の類義語にしておけば、後々の問題が少ない。
>
>
