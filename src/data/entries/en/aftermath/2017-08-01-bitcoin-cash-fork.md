...
Both of those analyses treat this August 1 fork as a load-bearing event in their own arguments. [The block-size war 2015–2017 overview](/BitcoinArchive/entries/analysis/2015-08-15-block-size-war-2015-2017-overview/) places it at the end of its phased reconstruction rather than chain consensus, and [the Bitcoin fork-and-altcoin family-tree analysis](/BitcoinArchive/entries/analysis/2008-10-31-bitcoin-fork-and-altcoin-genealogy/) places it in the genealogy as the 2017 split anchoring the post-2017 chain branches.
