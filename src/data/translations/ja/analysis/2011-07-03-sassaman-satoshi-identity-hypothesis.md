...
サッサマンは 2008–2011 年 — ビットコインの開発と初期運用の期間 — を通じて、 KU ルーヴェン大学の活動的な博士課程在籍者であった。 約 18 か月にわたるビットコイン集中コーディング期 (2007 年半ばから v0.1 リリースの 2009 年 1 月まで — 実装作業は 2008 年 8 月までに実質的に完了、 [サトシ自身の文書化された年表より](/BitcoinArchive/ja/entries/analysis/2008-10-31-cypherpunk-independent-arrival/))、 およびサトシが後に「2007 年から」「リリース前に 2 年間の開発」 と述べたより広い公開前設計期間は、 COSIC の博士課程在籍者であれば学究生活で最も高い負荷の時期と通常は重なる。 仮説は、 サッサマンが両方を — 博士課程の研究 *と* 数年にわたる集中的なビットコイン設計・コーディングの取り組みを — 同時並行で行ったことを要求する。 可能ではあるが、 無代償ではない。
