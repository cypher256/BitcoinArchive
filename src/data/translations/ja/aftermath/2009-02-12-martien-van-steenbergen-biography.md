...
2月13日の続くやり取りでは、ファン・ステーンベルゲンがリップル、プロトコル仕様、ビットコインが自己組織化的な通貨モデルをサポートできるかについて質問した。サトシはビットコインをプログラム可能なP2Pソーシャル通貨のための「基盤であり第一歩」と述べ、Pekunioやレピュテーションベースのシステムとの関係を議論した。
