...
*[編者注：本エントリーで用いる 2011-04-01 という日付は、ヴァーの最初に文書化されたビットコイン関与の代表的なプレースホルダーであり、2011 年初頭の正確な日付は彼の公開インタビュー間で一意に確定していない。一部の伝記的事実 (Memory Dealers 創業日、国籍離脱日、投資ポートフォリオ) は一次記録ではなくジャーナリストプロフィールでの公的言明に基づく。]*
