...
2. **Cited post-hoc (primary-source-confirmed).** Satoshi was *not* aware of the reference during development, learned of it later, and added the citation to the whitepaper's reference list. The August 21–22, 2008 emails confirm [Wei Dai's b-money](http://www.weidai.com/bmoney.txt) in this category.
