/* Shared animated Bitcoin-supply curve drawer. ONE implementation, used by
   ...
   (chart-embeds.js `supply-animated`). The supply curve fills toward 21M as
...
(function () {
  if (window.BASupplyCurve) return;
  ...
  window.BASupplyCurve = {
    ...
    mount: function (container, opts) {
      ...
      function render(cur) {
        ...
        gDyn.append('path').attr('fill', 'url(#ba-supply-grad)').attr('d', area(pts));
