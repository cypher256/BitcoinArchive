...
participants:
  ...
  - name: "Matt Corallo"
    slug: "matt-corallo"
description: "Defined the 'bitcoin:' URI scheme for standardized payment requests. Enables clickable Bitcoin addresses and QR codes with amount/label/message parameters — basis of user-friendly Bitcoin payments."
isSatoshi: false
tags:
  - "bip"
  - "uri-scheme"
...
This BIP has been superseded and replaced with BIP 321. Please see [BIP 321](https://github.com/bitcoin/bips/blob/master/bip-0321.mediawiki) instead.

# Original BIP

This BIP is a modification of an earlier [BIP 0020](https://github.com/bitcoin/bips/blob/master/bip-0020.mediawiki) by Luke Dashjr. BIP 0020 was based off an earlier document by Nils Schneider. The alternative payment amounts in BIP 0020 have been removed.
