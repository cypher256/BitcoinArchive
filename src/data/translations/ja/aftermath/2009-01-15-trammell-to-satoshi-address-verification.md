...
description: "トランメルがビットコインアドレスは IP 送金より安全と主張（複数チャネルで検証可能）。データ喪失への懸念、アドレス公開トグル、終了時ソケットクローズの問題を提起。"
isSatoshi: false
tags:
  - "correspondence"
  - "security"
...
続いてトランメルはデータ喪失について重要な懸念を提起した。これは[ウォレットバックアップ](/BitcoinArchive/ja/entries/design/2009-01-03-bitcoin-wallet-design/)に関する最も初期の議論の一つである。
