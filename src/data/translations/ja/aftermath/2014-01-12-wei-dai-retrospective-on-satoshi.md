...
本 2014 年の回顧は[ウェイ・ダイ同定仮説](/BitcoinArchive/ja/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/)において主要な反証として扱われている。同仮説はウェイ・ダイの「サトシはおそらく我々が名前を聞いたこともない誰かだろう」という回答に対し、冒頭の引用、 §1 の枠組み、 §2.5 の言及、 §3 の反証対比表、 LessWrong 上の返答に専用の §3.3、否認パターンを秤にかける §3.6、そして §5 の限界、と複数の節で繰り返し戻ってくる。仮説が説明し切らねばならない公的発言の記録として、本回顧を用いるのである。
