...
The [visual glossary](/BitcoinArchive/entries/analysis/2026-05-23-how-bitcoin-works-visual-glossary/) describes the protocol's basic shape as read from the whitepaper and the early design. Both are real: the protocol runs as written, and the operational reality built on top of it is a different thing.
