...
[ウェイ・ダイ](/BitcoinArchive/ja/participants/wei-dai/)がサトシだとする仮説は繰り返し提起されてきた —— 上記のウェイ・ダイ本人の否定が主要な反証の一つである。本仮説は候補プロファイル群 A（サトシがホワイトペーパーで明示的に引用した人物）に属し、暗号通貨ジャーナリズムで少なくとも 2010 年以降議論されてきた。
...
本ウェイ・ダイ同定仮説は[ウェイ・ダイ伝記](/BitcoinArchive/ja/participants/wei-dai/)に根拠を置いている。同伝記は仮説が支持証拠および反証の各節を通じて秤にかける文書的基盤 ― 学術記録、 b-money 提案、サイファーパンクへの参加、そして回顧的発言 ― を提供する。
