...
ジェフ・ガージックは 2010 年からサトシと共に開発した初期のコア開発者で、後にコードの外側からこの不在を指摘している。サトシは既知の暗号技術をそのまま流用し、新しい方法で組み合わせたが、モジュール化やユニットテストといった正規のコンピューターサイエンス教育で学ぶ基本が欠けていた ([ガージックの回顧録](/BitcoinArchive/ja/entries/aftermath/2024-10-28-jeff-garzik-satoshi-lone-genius/)参照)。
