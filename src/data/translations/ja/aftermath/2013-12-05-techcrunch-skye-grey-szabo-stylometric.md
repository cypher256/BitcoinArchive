...
本記事はこれらの文体所見を、それ以前から提示されていた概念的論拠と組み合わせた：サボの[Bit Gold 提案](/BitcoinArchive/ja/entries/aftermath/2008-04-27-nick-szabo-bit-gold-implementation-request/)（1998 年構想、2005 年 12 月 29 日に Unenumerated ブログで完全公開）はビットコインの建築に最も近い公表済みの前駆であり、サボの[2008 年 4 月の Bit Gold 実装協力を要請したメーリングリスト投稿](/BitcoinArchive/ja/entries/aftermath/2008-04-27-nick-szabo-bit-gold-implementation-request/)はビットコイン白書の半年前に、同じ問題空間で能動的に活動していたサボを位置づけている。
...
Skye Grey の分析は手作業による文体計量である：人間の判断による句とパターンの照合であり、アルゴリズムによる統計的指紋判定ではない。2014 年 4 月の Aston University の法言語学的研究は — 候補 11 名のうちサボを最も近い一致と独立に位置づけた — より形式化された文体計量手法を適用し、類似の結論に到達した。2026 年の[ジョン・カレイロウ / NYT 調査記事](/BitcoinArchive/ja/entries/aftermath/2026-04-08-nyt-carreyrou-adam-back-satoshi-investigation/)は、候補 620 名に対するアルゴリズムによる大規模集団文体計量比較を用い、代わりに[アダム・バック](/BitcoinArchive/ja/participants/adam-back/)を首位に挙げたが、NYT 分析を委託されていた言語学者のフロリアン・カフィエロは、結果は不確定であると自ら述べた。文体計量的方法論は、これら 3 件の独立調査において、コーパスと方法に応じて 2 つの異なる首位候補を生み出してきた。
