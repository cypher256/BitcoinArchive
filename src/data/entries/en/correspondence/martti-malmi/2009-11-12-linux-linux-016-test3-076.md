...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi releases linux-0.1.6-test3 with zombie socket detection, faster reconnection, and warnings for generated blocks not received by other nodes."
isSatoshi: true
tags:
  - "early-contributor"
  - "linux"
...
>> downloading, I took a look a look at my BitTorrent client, and
>> sure enough, I had forgotten about a torrent and my upload was
