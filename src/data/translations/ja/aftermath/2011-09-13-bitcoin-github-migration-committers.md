...
本アーカイブが直接確認できないのは：移行の意思決定が複数の開発者間で非公開で審議されたか、本アーカイブに保全されていないチャネル（メール、IRC など）でコミュニティ協議があったか、それともギャビン側の単独判断だったか、である。「単独意思決定」「コミュニティ審議を経ていない」と推論することは*不在からの推論*としてはあり得るが、直接の文書証拠による確認ではない。明示的な公的告知あるいは非公開審議の文書が判明した場合は、記録と評価を更新する。
