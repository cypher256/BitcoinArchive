...
> **部分翻訳警告 — 散文は未訳**
> 
> 本 BIP は見出しのみが日本語化されており、**本文の散文 (Motivation / Rationale / Specification の論述部分等) は英文のまま** 保持されている。数式・コード・テストベクトル・MediaWiki 表は技術精度のため翻訳対象外。散文の逐語訳は段階別の翻訳計画で順次補完される予定。
> 
> 原文: https://github.com/bitcoin/bips/blob/master/bip-0341.mediawiki
