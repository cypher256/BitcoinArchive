...
<!-- speaker: narrator -->
これはトッドのBitcoinTalkでの2回目の投稿で、登録から3日後だった。[サトシの最後の公開フォーラム投稿](/BitcoinArchive/ja/entries/forum/bitcointalk/topic-2228/2010-12-12-satoshi-final-post/)はその2日後だった。5年後、トッドはまさにサトシが説明していた概念を正式化した。
