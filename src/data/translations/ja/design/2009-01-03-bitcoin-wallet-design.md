...
v0.1 ではウォレットはインターフェース境界なしにノードバイナリーに組み込まれていた。GUI、鍵ストア、マイナー、検証エンジンがすべて単一のプロセスと単一の Berkeley DB ファイル（`wallet.dat`）を共有していた。初回リリース時には RPC サーバーは存在しなかった。JSON-RPC が加わったのは[v0.2.6（2010 年 2 月）](/BitcoinArchive/ja/entries/forum/bitcointalk/topic-63/2010-02-23-command-line-and-json-rpc/) — 発売から約 13 か月後 — で、その年の 7 月の [v0.3 リリース](/BitcoinArchive/ja/entries/aftermath/2010-07-06-bitcoin-v0.3-released/)で初めて主要機能に格上げされた。
