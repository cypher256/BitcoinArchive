---
title: "ニック・サボがビットコイン白書の著者と特定 — アストン大学法言語学センターによるサトシ候補 11 名の文体計量研究「Project Bitcoin」（2014 年 4 月）"
...
description: "2014 年 4 月、英国バーミンガムのアストン大学法言語学センターが「Project Bitcoin」 の結果を発表した。法言語学を専攻する最終学年の学生 40 名が、ジャック・グリーヴ博士の指導下で実施した文体計量研究で、検討した 11 名のサトシ候補のうちニック・サボがビットコイン白書の著者として最も可能性が高いと結論づけた。11 名の候補にはドリアン・S・ナカモト、ヴィリ・レードンヴィルタ、マイケル・クリア、ニック・サボに加え、サトシ候補として広く挙げられてきた他 7 名が含まれていた。方法論としては、サボ自身のウェブサイトに公開されている学術論文 40 本以上と他の候補者各々の対応する執筆サンプル群を含む数百の文書を調査し、特徴的な言語パターンを探した。グリーヴが報告した結論：「サボの執筆とビットコイン白書の言語的類似性の数は際立っており、他のいかなる候補もこの一致の度合いに到底及ばない」。本研究は 2014 年 4 月 16 日に CoinDesk で報じられ、続いて 4 月 17 日に ScienceDaily およびアストン大学のプレスリリース、その後 Slate、Sci.News、Cointelegraph、Phys.org で取り上げられた。本研究は、サトシ著者性に関する最初の複数候補横断的な学術側文体計量研究であり、2013 年 12 月の Skye Grey による LikeInAMirror 調査を踏まえつつ、両者ともサボを首位候補に挙げ、その後ナサニエル・ポパーの 2015 年『ニューヨーク・タイムズ』 調査記事でも引用された。アストン大学の広報担当は公開時点で、本報告書は査読を受けておらず、近い将来に査読の予定もないと述べた。批判的な後続報道（特にデイヴィッド・ジェラードの 2018 年記事）は、授業課題としての標本サイズ・候補者の事前選定設計の方法論的限界を指摘した。"
isSatoshi: false
tags:
  - "nick-szabo"
  - "satoshi-identity"
...
secondarySources:
  ...
  - name: "Phys.org — 'Researchers uncover likely creator of Bitcoin'（2014 年 4 月）"
    url: "https://phys.org/news/2014-04-uncover-creator-bitcoin.html"
  - name: "Slate — 'Forensic linguistics analysis suggests Nick Szabo wrote the bitcoin paper'（2014 年 4 月）"
  ...
  - name: "Wikipedia — Jack Grieve（アストン大学教員プロフィール）"
...
検討された 11 名の候補は、それまでのジャーナリズムとフォーラム言説で名指しされていた人物群である：
...
— に加え、広く挙げられるサトシ候補リストから抽出された他 7 名。アストンチームは候補者ごとに数百の文書サンプルを検討し、特にサボについては大規模な標本を用意した：彼の個人サイトに公開されている 40 本以上の学術論文と、Unenumerated ブログ投稿の相当量のコーパスである。

**方法論：**

アストン研究は**法言語学的・文体計量分析**を適用した。これは訴訟用文書鑑定・脅迫文の帰属特定・歴史的著者性論争などで用いられる手法群である。検討された変数は以下を含む：

- 候補者間コーパスでの特徴的な語彙使用。
- 句読点と綴りの慣行（特にサトシの執筆に見られる英米綴り混成と句点後のダブルスペースのパターン）。
- 文構造のパターンと統語選好。
- ハイフン用法と複合語形成。
- 複数の執筆文脈型を横断する繰り返し現れる談話標識と文体的特徴。

**報告された結論：**

公開時点でグリーヴが報告した要約発言：

> サボの執筆とビットコイン白書の言語的類似性の数は際立っており、他のいかなる候補もこの一致の度合いに到底及ばない。私たちは、主要な容疑者のうちニック・サボが本論文の主要著者であると、かなりの確信を持っている。ただし他者が貢献した可能性を排除することはできない。

第二文の留保は方法論的に重要である：グリーヴは単独著者性を主張せず、複数著者貢献の可能性を明示的に開いたまま、サボを主要な一致対象として名指している。

**公開時に表明された方法論的留意点：**

アストン大学の広報担当は公開時点で次のように認めていた：

- 本報告書は査読を受けておらず、近い将来に査読の予定もない。
- 本研究は、研究室主導の研究成果ではなく、最終学年の法言語学の授業課題として実施された。
...
| 研究 | 日付 | 候補範囲 | 首位 | 数値データ公開 |
|---|---|---|---|---|
| [Skye Grey](/BitcoinArchive/ja/entries/aftermath/2013-12-05-techcrunch-skye-grey-szabo-stylometric/) | 2013 年 12 月 | サボ単独（仮説検証型） | サボ | 否（語句リストの叙述） |
| **アストン大学** | **2014 年 4 月** | **11 候補** | **サボ** | **否（プレスリリース上の結論）** |
| [ヴァン・ドルスト](/BitcoinArchive/ja/entries/aftermath/2024-04-13-van-dorst-where-is-satoshi-stylometric-corpus/) | 2024 年 4 月 | 75,000+ | 指名なし | 可（XLSX/CSV 公開） |
| カフィエロ／[カレイロウ NYT](/BitcoinArchive/ja/entries/aftermath/2026-04-08-nyt-carreyrou-adam-back-satoshi-investigation/) | 2026 年 4 月 | 12（焦点）／620（広範） | アダム・バック（ハル・フィニーがほぼ同点） | 否（NYT 記事内に結果要約） |
