---
title: "サトシは何を知っていたか — サイファーパンク中核思想への到達"
...
サイファーパンク運動は、ビットコインに至る 10 年あまりの間に、デジタル通貨と PoW に関する一連の提案を生み出した（これらのうちビットコインが何を再利用し、何を借り、何を新たに統合したかについての構成要素単位の分析は[ビットコインの設計系譜分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-bitcoin-design-lineage/)で扱う）。各提案は本アーカイブにエントリがある:
