...
**定額インフレ＝退蔵を嫌う決済通貨（ドージコイン）。** 健全通貨が長所とみなす希少性を、ここでは欠陥とみなす。明日値上がりするものは使われず退蔵され、通貨としては死ぬ。だから 2014 年に上限を撤廃し、ブロックあたり 1 万 DOGE（年約 53 億枚）を永久に発行する。緩やかなインフレで退蔵より支出を促し、手数料を低く保つ。「持つ資産」ではなく「使う通貨」への賭けだ。
