...
For details of WHY exactly I felt the need to redo python-jsonrpc using a raw socket, check out the follow forum post: [JSON-RPC Multiple Invocations](/BitcoinArchive/ja/entries/forum/bitcointalk/2010-07-24-re-json-rpc-multiple-invocations/)
