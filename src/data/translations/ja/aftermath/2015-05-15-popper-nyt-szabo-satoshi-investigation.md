...
- **Bit Gold の概念的近接。** サボの Bit Gold 提案は、計算的プルーフオブワークによる成果物の連鎖を、ビザンチン耐性のあるサーバー網で認証する設計であり、公表されたあらゆる先行構想の中で、ビットコインの設計上の問題空間を最も近く先取りしていた。ポパーは Bit Gold を「ビットコインに最も近い前駆」と表現した。
...
ポパーは取材中にサボに接触した。サボはメールで特定を否定した。否定はその後の Wikipedia 各種記事およびジャーナリズムの追跡記事で広く引用されている。否定の趣旨には、デジタル現金問題に知的に取り組んでおり、かつ実装の技術的素養もあったとサボ自身が考える候補が、[ウェイ・ダイ](/BitcoinArchive/ja/participants/wei-dai/)と[ハル・フィニー](/BitcoinArchive/ja/participants/hal-finney/)という形で他にいた、という主張が含まれていた。
