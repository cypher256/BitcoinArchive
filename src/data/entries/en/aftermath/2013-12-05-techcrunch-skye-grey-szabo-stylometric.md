...
This TechCrunch report is the foundational primary source on which [the Nick Szabo identity hypothesis](/BitcoinArchive/entries/analysis/2013-12-05-szabo-satoshi-identity-hypothesis/) builds its stylometric pillar. The hypothesis returns to Skye Grey's findings across its supporting-evidence sections as the documented first-mover quantitative argument that the counter-evidence (continuous Unenumerated visibility, the April 2008 implementation request, the May 2011 framing) must displace.
