...
## Where this entry is invoked

The independent-arrival reading developed here recurs as a load-bearing reference in the post-2014 identification corpus. It functions as the upstream framing for the [identity-hypotheses overview](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identity-hypotheses-overview/) and for each individual candidate hypothesis — the [Adam Back hypothesis](/BitcoinArchive/entries/analysis/2026-04-08-adam-back-satoshi-identity-hypothesis/), [Wei Dai hypothesis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/), [Nick Szabo hypothesis](/BitcoinArchive/entries/analysis/2013-12-05-szabo-satoshi-identity-hypothesis/), and [Hal Finney hypothesis](/BitcoinArchive/entries/analysis/2014-03-25-hal-finney-satoshi-identity-hypothesis/) — each of which has to address the "independent arrival vs. visible-community member" question this entry raises. The biographies of [Satoshi](/BitcoinArchive/participants/satoshi-nakamoto/), [Adam Back](/BitcoinArchive/participants/adam-back/), [Wei Dai](/BitcoinArchive/participants/wei-dai/), and [Hal Finney](/BitcoinArchive/participants/hal-finney/) also reach back into the structural reading here when framing their subjects' relation to the cypherpunk channel. The single-source primary record — the [August 21, 2008 Satoshi-to-Adam-Back email chain](/BitcoinArchive/entries/aftermath/2008-08-21-adam-back-to-satoshi/) — is the b-money-disclaimer evidence this entry's argument hinges on.
