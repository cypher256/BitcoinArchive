...
ParseStringにこの問題があることを確認し、修正したutil.cppをSVNにアップロードしました。

string::npos == -1

unsigned int -1 (0xffffffff) と long unsigned int -1 (0xffffffffffffffff) を比較すると、unsigned intが64ビットに昇格され、0x00000000ffffffff != 0xffffffffffffffff となります。
