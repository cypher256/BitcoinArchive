...
- **[2009年6月4日](/BitcoinArchive/ja/entries/aftermath/2009-06-04-bohm-to-satoshi-router-issue/)** 、ニコラス・ボームは新しいルーターを導入して以来、ビットコインが接続できなくなったと報告した。
...
本 2024 年の開示は[ニコラス・ボーム伝記](/BitcoinArchive/ja/participants/nicholas-bohm/)から記録された開示事件として扱われる。同伝記は本エントリを、ボームによる以前は非公開だった 2009 年のサトシ通信の出典として、そしてボームによるサトシとの直接の私的やり取りの伝記的読解の基盤として用いる。
