...
<!-- speaker: Peter Todd -->
2010年12月10日、ピーター・トッド（当時「retep」として投稿）はサトシのトランザクション置換の説明に対して技術的な指摘で返信した：

> 「もちろん、正確に言えば、2つ目のトランザクションに手数料がある場合、入力と出力は*正確には*一致しない」

<!-- speaker: narrator -->
これはトッドのBitcoinTalkでの2回目の投稿で、登録から3日後だった。サトシの最後の公開フォーラム投稿はその2日後だった。5年後、トッドはまさにサトシが説明していた概念を正式化した。
