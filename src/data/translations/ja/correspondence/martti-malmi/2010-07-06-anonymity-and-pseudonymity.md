...
<!-- speaker: narrator -->
サトシとマルミのやり取りの中で最も先見性のあるメールの一つで、サトシはウェブサイトやプロモーション資料でビットコインのプライバシー特性がどのように説明されているかについてマルミに警告した：
...
「IP 送金」についての言及は、トランザクションを IP アドレスに直接送信できた初期のビットコイン機能を指している。ネットワークがアドレスベースのトランザクションに移行するにつれて、プライバシーモデルはサトシが明確に伝える必要があると感じた方法で変化した。
