...
description: "ニコラス・ボームが v0.1.5 をトラブル無く運用、 201 トランザクションを蓄積したと報告し、サトシに「次は何ですか？」 と問う。"
isSatoshi: false
tags:
  - "mailing-list"
  - "user-report"
...
バージョン 0.1.5 はトラブルなく動作しているようだ。201 件のトランザクション一覧があり、 約 bc8550 を蓄積している。送金と受取は問題なく動作している（受信トランザクションのラベル付けを理解するのに少し頭を抱えたが）。
