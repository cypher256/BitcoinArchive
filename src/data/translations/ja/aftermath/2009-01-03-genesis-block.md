...
これがサトシが Bitcoin の設計の中に置いた、ただ一つの個人の声だ。他のあらゆる場面で、彼は身元の手がかりを丹念に削っていた。Tor を使い、メールアカウントをアドレスごとに使い分け、英米綴りを混在させ、タイピング癖に注意を払い、自ら退場する ([匿名性アーキテクチャ分析](/BitcoinArchive/ja/entries/analysis/2008-10-31-satoshi-anonymity-architecture/)に全体像)。設計の中のある一点だけ、彼は痕跡を削ることを止めて、逆に一つ挿入した。その一点に選んだ場所が、Bitcoin の最初のブロックだった。システムが持つもっとも永続的な表面である。
