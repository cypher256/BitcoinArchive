---
title: "Re: 0.3.20 release : shipped"
...
participants:
  ...
  - name: "Martti Malmi"
    slug: "martti-malmi"
description: "Satoshi sends the bitcoin-list mailman admin password to Gavin and Martti as PGP-encrypted blocks. Last email in the Malmi archive (#260)."
isSatoshi: true
tags:
  - "early-contributor"
  - "final-message"
...
*[Context: Raw header has both Gavin Andresen and Martti Malmi in the To: field, but the body is a reply to Gavin — Satoshi addresses Gavin in the second person ("Martti should give *you* the Drupal admin password") and refers to Martti in the third, looping Martti into To: so he knows to perform the Drupal handoff. Reply on the "0.3.20 release : shipped" thread. The body labels "Gavin:" and "Martti:" further down are Satoshi's own headings for the two PGP-encrypted blocks — one encrypted to each recipient's public key — not separate addressees.]*
