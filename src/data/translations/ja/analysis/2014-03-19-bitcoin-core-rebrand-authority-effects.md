...
本再ブランディング権威効果分析は二つの後続読解によって、 2014〜2017 年統治弧の命名軸として用いられる。 [フォーク戦争はオープンソースの話ではない分析](/BitcoinArchive/ja/entries/analysis/2015-08-15-bitcoin-fork-wars-as-not-oss/)はビットコイン統治の構造的読解の「命名軸」として本エントリを相互参照する。 [マイク・ハーン「決着」エッセイ](/BitcoinArchive/ja/entries/aftermath/2016-01-14-mike-hearn-resolution-bitcoin-experiment/)は本再ブランディングを、統治失敗の判決が拠り所とする転換点の一つとして扱う。
