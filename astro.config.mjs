...
import { remarkVisualEmbed } from './src/lib/remark-visual-embed.mjs';
import { remarkFaqCard } from './src/lib/remark-faq-card.mjs';
...
export default defineConfig({
  ...
  markdown: {
    remarkPlugins: [remarkRewriteBase, remarkQuoteBlocks, remarkSpeakerBlockquote, remarkEditorialMarker, remarkEntryClosing, remarkChartEmbed, remarkVisualEmbed, remarkFaqCard, [remarkMath, { singleDollarTextMath: false }]],
