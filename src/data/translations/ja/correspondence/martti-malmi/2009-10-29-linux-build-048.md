...
quotes:
  - id: "q1"
    ...
    sourceEntryId: "correspondence/martti-malmi/2009-10-29-bitcoinsourceforgenet-047"
  - id: "q2"
    parent: "q1"
...
<!-- tone-skip -->
> <!-- quote: q2 -->
>> CriticalSection のコードを wxCriticalSection に変換して SVN にアップロード
>> するよ（少しトリッキーだけど）。TryEnterCriticalSection をどうするかは
