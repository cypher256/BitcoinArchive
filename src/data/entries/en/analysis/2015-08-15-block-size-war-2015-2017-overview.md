...
<!-- entry-closing -->
The line was written as spam protection and defended as identity. What ended the war was not a vote and not a better argument, but one side announcing, in a mailing-list post, that the second half of its own agreement would not go ahead. Since then the chain has changed only in ways that required no one to leave, and every later dispute I can trace has inherited the question this one left open: not whether a change is right, but who can be made to accept it.
