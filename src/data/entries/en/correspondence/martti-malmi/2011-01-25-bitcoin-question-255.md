...
*[Editor: Martti adds a one-line preamble ("Can you comment on this?") and forwards a three-deep email thread with Constance J. Wells, a US graduate student referred to Bitcoin by Mark Herpel. From the outside in: Constance writes back thanking Martti for the Bitcoin PDF and explaining her thesis context; her reply contains Martti's earlier response granting citation permission and pointing to bitcoin.org/bitcoin.pdf; that response in turn quotes Constance's original inquiry. The body below mirrors Satoshi's reply-quote in [#256](/BitcoinArchive/entries/correspondence/martti-malmi/2011-01-25-bitcoin-question-256/) with one less quote-depth (the mmalmi.github.io HTML rendering for #255 drops Martti's preamble — the text lives outside a Yahoo-style `<table>` wrapper that the rendering only includes the inside of — but the preamble is preserved verbatim in #256's reply-quote, so the Archive treats it as the canonical text of #255).]*
