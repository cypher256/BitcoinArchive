...
This XT launch is treated as the inaugural event of the block-size war in two later readings. [The Mike Hearn "Resolution" essay](/BitcoinArchive/entries/aftermath/2016-01-14-mike-hearn-resolution-bitcoin-experiment/) reads this launch as the proximate context of Hearn's departure — the production-fork release whose collapse precipitated the January 2016 verdict.

[The "fork wars as not OSS" analysis](/BitcoinArchive/entries/analysis/2015-08-15-bitcoin-fork-wars-as-not-oss/) treats the same August 15 release as the date a Bitcoin Core fork crossed the production-software threshold, using it as the date-anchor for the governance-failure case study its argument depends on.
