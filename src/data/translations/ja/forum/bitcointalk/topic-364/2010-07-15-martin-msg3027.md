...
participants:
  - name: "martin"
    slug: "martin"
description: "martin がスレッドを開始: BitcoinTalk トピック 364。"
isSatoshi: false
tags: []
...
-> bitcoin の代わりに走らせられる単一の実行ファイルにパッケージングし、バックグラウンドで動作させ、bitcoin プロセスの終了に合わせて自動終了するようにする方向を検討する
