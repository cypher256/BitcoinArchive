...
sourceNote: "Methodology, dataset, and 43 MB comparison.xlsx aggregate (76,407 author-source rows × 76 columns) used as input to this reanalysis."
...
![Dark teal data-visualization graphic featuring a curved line chart scattered with many small dots, five larger glowing amber dots clustered near the peak each labeled with a name, and a side panel showing a large number above a cluster of scattered dots.](/BitcoinArchive/images/analysis/2026-05-03-van-dorst-corpus-reanalysis-named-candidates-hero.png)
...
This reanalysis is also read into the broader identification corpus from three further angles. [The Wei Dai identity hypothesis](/BitcoinArchive/entries/analysis/2008-08-22-wei-dai-satoshi-identity-hypothesis/) cites it as the quantitative anchor of its §2.4 stylometric-distance treatment and revisits it in the §2 counter-evidence summary, §3, and §4 limits. [The Hal Finney identity hypothesis](/BitcoinArchive/entries/analysis/2014-03-25-hal-finney-satoshi-identity-hypothesis/) uses the specific Finney placement (top 6.8% across the 75,000-author corpus) as the supporting argument in §1.3 and returns to the reanalysis in §3 broader-record framing and §4 as a foundational source. And [the identification-asymmetry analysis](/BitcoinArchive/entries/analysis/2008-10-31-satoshi-identification-asymmetry/) treats this reanalysis as the primary source for the §1.3 stylometric-attribution row, includes it in the mermaid timeline of named-candidate attribution attempts, and uses its specific findings (594 unnamed authors closer than the closest named candidate) to argue the named-candidate-vs-unnamed-corpus asymmetry.
