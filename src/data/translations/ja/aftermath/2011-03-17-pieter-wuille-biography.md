...
- **[BIP-32](/BitcoinArchive/ja/entries/bip/2012-02-11-bip-0032/)**（2012年）— 階層的決定性ウォレット（HD ウォレット）。1 つのマスターシードから鍵ツリー全体を導出することで「頻繁なウォレットバックアップ」問題を解消。現代のあらゆるビットコインウォレットの基盤。
