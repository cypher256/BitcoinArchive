...
[sirius-mの2010年1月5日 01:20:06 AMの投稿より引用](/BitcoinArchive/ja/entries/forum/bitcointalk/2010-01-05-sirius-msg84/)引用：「しかし、そのトランザクションが完了した後、新しいトランザクションが開始されていません。あるいは開始されているのかもしれません。リストにはトランザクションが1つしかありませんが、「ステータス」のブロック数は131まで増えています。これが正しい動作なのでしょうか？同じトランザクションで処理を続け、120ブロックごとにコインを生成するのですか？それとも新しいトランザクションを開始するはずなのですか？」
