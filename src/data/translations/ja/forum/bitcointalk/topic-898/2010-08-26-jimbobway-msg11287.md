...
participants:
  - name: "jimbobway"
    slug: "jimbobway"
description: "BitcoinTalk トピック 898 における jimbobway の文脈投稿。after msg11219, サトシを引用."
isSatoshi: false
tags: []
quotes:
  - id: "q1"
...
>
> アラートシステムに関して言えば、誰が気にするんだ？鍵にできる最大のことは、サイト運営者が `-disablesafemode` スイッチを追加するかアップグレードするまで、6 つの JSON-RPC コマンドを一時的に無効化することだけだ。全ノードは引き続き動作し、生成を続け、ネットワークは稼働したままだ。もし私が対応できなくなっても、どんなスクリプトキディでも 2 文字追加してアラートシステムを無効化する新バージョンを作る方法を見つけられる。一時的な不便でしかない。
>
>
>
> <!-- quote: q4 -->
