...
If the intention is to prevent *all* other access, I'd suggest giving up on that goal 😊  It is highly useful to permit db4 tools to access db4 databases:Code:db46_archive     db46_deadlock    db46_load        db46_stat
