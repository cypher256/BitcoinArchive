...
- **COPA v Wright (英国高等裁判所、2024 年 3 月 14 日)** — ジェームズ・メラー判事がクレイグ・ライトに対し 4 つの認定を下した: ビットコイン論文の著者ではない、2008〜2011 年にサトシとして活動した人物ではない、ビットコインシステムの作成者ではない、初期ビットコインソフトウェアの著者ではない。判決はライトが「サトシ・ナカモトであるという虚偽の主張を支えるために、意図的かつ広範な文書偽造を行った」と結論付けた。詳細は [COPA 判決エントリ](/BitcoinArchive/ja/entries/aftermath/2024-03-14-copa-v-wright-ruling/)参照。
...
- **セルジオ・デミアン・ラーナー — Patoshi マイニングパターン (2013 年 4 月、2019 年・2020 年に追加分析)** — ラーナーは初期ブロックのコインベースデータに 2 つの独立した指紋を発見した: ExtraNonce の傾きと、ナンス最下位バイトの分布が約 50 個の特定値に限定されていること。これらは一貫して 1 人の初期マイナーを示している。分析では Patoshi マイナーの保有量を 22,503 ブロックにわたる約 110 万 BTC と推定している。詳細は [Patoshi 分析エントリ](/BitcoinArchive/ja/entries/aftermath/2013-04-17-sergio-lerner-patoshi-analysis/)参照。
...
- **ピーター・トッド** — HBO 2024 で名指された (§1.1)。否定 (放送当日の CoinDesk への取材で「もちろん、私はサトシではない」)。トッドはドキュメンタリーを無責任な主張として退けた。
