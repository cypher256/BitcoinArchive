...
**サトシの記述** (ホワイトペーパー § 5「Network」): *「They [nodes] vote with their CPU power, expressing their acceptance of valid blocks by working on extending them...」* (ノードたちは CPU の力で投票し、 有効なブロックを延長する作業を通じて受容を表明する)。 描かれるのは、 多数の独立した運営者の作業から、 メカニズムだけで合意が立ち上がる構図であり、 特権的な意思決定者はいない。
