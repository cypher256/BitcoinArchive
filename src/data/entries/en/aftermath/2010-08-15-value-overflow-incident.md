...
**The response:** Within approximately five hours of discovery, Satoshi published [Bitcoin version 0.3.10](/BitcoinArchive/en/entries/sourceforge/2010-08-15-bitcoin-v0.3.10-overflow-bug-fix/) containing a soft fork that added two new checks to `CheckTransaction()`:
