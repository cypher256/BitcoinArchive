---
title: "Re: [bitcoin-list] ビットコインはWindowsでクラッシュしますか？"
...
participants:
  ...
  - name: "Eugen Leitl"
    slug: "eugen-leitl"
description: "Liberty StandardによるWine上でのビットコインクラッシュ報告に対するサトシの返信。Wine互換性の問題と判断。オイゲン・ライトルも同スレッドでDebianパッケージについて質問。"
isSatoshi: true
secondarySources:
