...
participants:
  ...
  - name: "Hal Finney"
    slug: "hal-finney"
description: "ハル・フィニーが初アルファリリースに祝意を表し、有名な思考実験を披露: ビットコインが世界の支配的決済になれば各コインは約 1000 万ドル——早期マイニングは 1 億対 1 の賭け、と述べた。"
...
<!-- tone-skip -->
<!-- speaker: Satoshi Nakamoto -->
> 総発行量は 21,000,000 コインだ。ネットワークノードがブロックを生成する際に配布され、その量は 4年ごとに半減する。
>
