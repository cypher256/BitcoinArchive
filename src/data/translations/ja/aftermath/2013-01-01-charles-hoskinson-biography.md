...
ビットコインが安定した識別子を持たないことを、迂回すべき不都合として扱っていない。カルダノが継がないと決めたものとして名指ししている。供給の軸では両者は一致していて、[固定供給と自動調整の比較](/BitcoinArchive/ja/entries/analysis/2008-10-31-fixed-supply-vs-adjustable-money/)はカルダノをビットコイン・ライトコインと同じ上限あり群に置いている。分岐は希少性ではなく、合意形成と識別子の側を走っている。
