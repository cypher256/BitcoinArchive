---
title: "El Salvador becomes the first country to make bitcoin legal tender (September 7, 2021)"
date: "2021-09-07T00:00:00Z"
type: "article"
source: "coindesk"
sourceUrl: "https://www.coindesk.com/policy/2021/09/07/bitcoin-now-legal-tender-in-el-salvador-marking-world-first"
sourceNote: "Covers the Bitcoin Law's September 7, 2021 entry into force; see the sources below for the June 2021 vote, the law's text, and the Chivo wallet's rollout."
author: "Bitcoin Institute"
participants:
  - name: "Nayib Bukele"
    slug: "nayib-bukele"
description: "El Salvador's Bitcoin Law took effect on September 7, 2021, requiring merchants nationwide to accept bitcoin and launching the government's Chivo wallet with a $30 sign-up incentive."
isSatoshi: false
tags:
  - "el-salvador"
  - "legal-tender"
...
secondarySources:
  - name: "Bitcoin en El Salvador (Wikipedia, Spanish)"
    ...
    note: "Details the June 8-9, 2021 legislative vote and Official Gazette publication."
  - name: "El Salvador's Bitcoin Law, full English text (FREOPP)"
    ...
    note: "English translation of Articles 1, 4, 5, and 7."
  - name: "Bitcoin Law (Wikipedia)"
    url: "https://en.wikipedia.org/wiki/Bitcoin_Law"
    note: "Covers the Chivo wallet's $30 incentive, download figures, and launch-day outages."
  - name: "Opposition poses constitutional challenge to El Salvador's Bitcoin Law (Cointelegraph)"
    ...
    note: "Reports the citizens' and FMLN's constitutional lawsuit against the law."
relatedEntries:
...
![An illustration of a gold-outlined silhouette of El Salvador on a dark-navy background, beside a glowing bitcoin symbol, a small government-building icon, and a smartphone showing a wallet interface, with a faint courthouse silhouette in one corner and September 7 marked on a small calendar icon.](/BitcoinArchive/images/analysis/2021-09-07-el-salvador-bitcoin-law-hero.png)
...
timeline
    ...
    2021 : Legislative Assembly passes the Bitcoin Law, Decree No. 57 (dated Jun 8), 62 votes in favor of 84 seats, and publishes it in the Official Gazette, Tomo 431, No. 110 (Jun 9)
         : Citizens and FMLN's Jaime Guevara file a constitutional challenge (Jun)
         : Bitcoin Law enters into force; Chivo wallet launches with a $30 sign-up incentive (Sep 7)
         : Chivo downloaded by about 3 million people, roughly 46% of the population, amid launch-day outages (within the first month)
```
